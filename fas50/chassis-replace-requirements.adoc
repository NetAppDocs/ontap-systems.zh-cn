...
summary: 在更换 FAS50 存储系统的机箱之前，请确保满足成功更换的必要要求。这包括验证系统中的所有其他组件是否正常运行，验证您是否拥有正确的替换底盘以及必要的工具。 
---
= 机箱更换要求- FAS50
:allow-uri-read: 
:icons: font
...
[role="lead"]
在更换 FAS50 存储系统的机箱之前，请确保满足成功更换的必要要求。这包括验证系统中的所有其他组件是否正常运行，验证您是否拥有正确的替换底盘以及必要的工具。
