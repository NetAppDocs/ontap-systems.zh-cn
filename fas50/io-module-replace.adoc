...
summary: 如果FAS50系统中的I/O模块发生故障或需要升级以支持更高性能或其他功能、请更换该模块。更换过程包括关闭控制器、更换发生故障的I/O模块、重新启动控制器以及将发生故障的部件退回NetApp。 
---
= 更换I/O模块- FAS50
:allow-uri-read: 
:icons: font
...
[role="lead"]
如果FAS50系统中的I/O模块发生故障或需要升级以支持更高性能或其他功能、请更换该模块。更换过程包括关闭控制器、更换发生故障的I/O模块、重新启动控制器以及将发生故障的部件退回NetApp。
