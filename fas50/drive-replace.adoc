...
summary: 当驱动器发生故障或需要升级时，请更换 FAS50 存储系统中的驱动器。更换过程包括识别故障驱动器、安全移除它以及安装新驱动器以确保持续的数据访问和系统性能。 
---
= 更换驱动器 - FAS50
:allow-uri-read: 
:icons: font
...
[role="lead"]
当驱动器发生故障或需要升级时，请更换 FAS50 存储系统中的驱动器。更换过程包括识别故障驱动器、安全移除它以及安装新驱动器以确保持续的数据访问和系统性能。
