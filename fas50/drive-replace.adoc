...
summary: 当驱动器出现故障或需要升级时，在 FAS50 存储系统中热插拔驱动器。更换过程包括识别故障驱动器、安全地将其移除，以及安装新驱动器，以确保持续的数据访问和系统性能。 
---
= 热插拔 FAS50 系统中的驱动器
:allow-uri-read: 
:icons: font
...
[role="lead"]
当驱动器出现故障或需要升级时，在 FAS50 存储系统中热插拔驱动器。更换过程包括识别故障驱动器、安全地将其移除，以及安装新驱动器，以确保持续的数据访问和系统性能。
