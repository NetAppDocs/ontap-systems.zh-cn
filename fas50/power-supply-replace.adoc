...
summary: '如果FAS50系统中的交流或直流电源设备(PSU)发生故障或出现故障、请予以更换、以确保系统继续获得稳定运行所需的电源。更换过程包括断开故障PSU与电源的连接、拔下电源线、更换故障PSU、然后将其重新连接到电源。' 
---
...
[role="lead"]
如果FAS50系统中的交流或直流电源设备(PSU)发生故障或出现故障、请予以更换、以确保系统继续获得稳定运行所需的电源。更换过程包括断开故障PSU与电源的连接、拔下电源线、更换故障PSU、然后将其重新连接到电源。
