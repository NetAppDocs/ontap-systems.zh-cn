...
[role="lead"]
<stdin>中未解析的指令- include：..//_include/C250_install-detice-gu导向.adoc[]
本节详细介绍了安装AFF C250系统的分步说明。
...
.步骤
. 使用25GbE集群互连缆线将集群互连端口e0c连接到e0c、并将e0d连接到e0image:../media/oie_cable_sfp_gbe_copper.png[""]：
+
