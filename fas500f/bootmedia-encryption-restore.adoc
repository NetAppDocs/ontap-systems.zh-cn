...
summary: 检查环境变量后，您必须完成特定于启用了板载密钥管理器 OKM、NetApp 存储加密 NSE 或 NetApp 卷加密 NVE 的系统的步骤。 
---
= 在手动启动恢复过程之后，在 FAS500f 系统中恢复启动介质上的加密
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
更换启动介质后，如果您的 FAS500f 系统使用 Onboard Key Manager、NetApp Storage Encryption 或 NetApp Volume Encryption 来保护数据，请恢复加密。
