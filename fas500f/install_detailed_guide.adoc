...
.步骤
. 使用动画 (https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=beec3966-0a01-473c-a5de-ac68017fbf29["为双节点无交换机集群布线"^]）或完成控制器与交换机之间布线的分步说明：
+
[cols="10,90"]
|===
| 步骤 | 在每个控制器上执行 
...
.步骤
. 使用动画 (https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=bf6759dc-4cbf-488e-982e-ac68017fbef8["为交换集群布线"^]）或完成控制器与交换机之间布线的分步说明：
+
[cols="10,90"]
|===
| 步骤 | 在每个控制器上执行 
...
image::../media/drw_affa250_mgmt_cabling.png[DRW affa250 管理布线]
 ...
 a| 
image::../media/oie_legend_icon_attn_symbol.png[OIE 图例图标 Attn 符号]
 a| 
此时请勿插入电源线。
...
image::../media/drw_affa250_fc_host_cabling.png[DRW affa250 fc 主机布线]
...
image::../media/drw_affa250_25gbe_host_cabling.png[DRW affa250 25GbE 主机布线]
...
.步骤
. 使用动画 (https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=3f92e625-a19c-4d10-9028-ac68017fbf57["使用缆线将控制器连接到一个 NS224"^]）或将控制器模块连接到单个磁盘架的分步说明。
+
[cols="10,90"]
|===
| 步骤 | 对每个控制器模块执行 
...
. 使用动画 (https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=d61f983e-f911-4b76-8b3a-ab1b0066909b["将笔记本电脑连接到管理交换机"^]）将笔记本电脑连接到管理交换机。
. 选择列出的 ONTAP 图标以发现：
+
