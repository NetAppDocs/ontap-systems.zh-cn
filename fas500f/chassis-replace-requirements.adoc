...
summary: 在更换 FAS500f 系统中的机箱之前，请确保满足成功更换的必要要求。这包括验证系统中的所有其他组件是否正常工作，验证您是否具有 ONTAP 的本地管理员凭据、正确的替换机箱和必要的工具。 
---
= 更换机箱的要求 - FAS500f
:allow-uri-read: 
:icons: font
...
[role="lead"]
在更换 FAS500f 系统中的机箱之前，请确保满足成功更换的必要要求。这包括验证系统中的所有其他组件是否正常工作，验证您是否具有 ONTAP 的本地管理员凭据、正确的替换机箱和必要的工具。
