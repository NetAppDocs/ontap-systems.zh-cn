...
[role="lead"]
查看 FAS500f 存储系统的部分规格，这些规格反映了单个高可用性对。请访问 https://hwu.netapp.com["NetApp Hardware Universe"^]（HWU）以获取 FAS500f 规格的完整列表。
...
* 声学噪声：标称声功率 (LwAd)：7.2；声压 (LpAm)（旁观者位置）：69.1 分贝
