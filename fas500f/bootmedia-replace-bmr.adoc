...
summary: FAS500f 系统中的启动介质存储了重要的固件和配置数据。更换启动介质需要卸下控制器模块、卸下受损的启动介质、安装替换启动介质，然后重新安装控制器模块。 
---
= 使用自动启动恢复过程更换 FAS500f 系统中的启动介质
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
FAS500f 系统中的启动介质存储了重要的固件和配置数据。更换启动介质需要卸下控制器模块、卸下受损的启动介质、安装替换启动介质，然后重新安装控制器模块。
