...
summary: 通过查看更换要求、关闭控制器、更换引导介质、恢复引导介质上的映像以及验证系统功能，开始更换 FAS500f 存储系统中的引导介质。 
---
= 使用自动启动恢复过程的 FAS500f 系统的启动介质更换工作流程
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
启动映像的自动恢复涉及系统自动识别和选择适当的启动菜单选项。它使用配对节点上的启动映像，在 FAS500f 存储系统的替换启动介质上重新安装 ONTAP。
