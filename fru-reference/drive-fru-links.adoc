...
summary: 查找按平台或机架系列组织的NetApp存储系统的硬盘更换流程。本参考资料提供了AFF、 ASA和FAS系统以及机架式系统的分步驱动器更换工作流程的直接链接，以帮助您快速找到适用于您特定型号的正确程序。 
---
= 按平台系列划分的驱动器更换流程
:allow-uri-read: 
:icons: font
...
[role="lead"]
查找按平台或机架系列组织的NetApp存储系统的硬盘更换流程。本参考资料提供了AFF、 ASA、 FAS和机架式系统的分步驱动器更换工作流程的直接链接，以帮助您快速找到适用于您特定型号的正确程序。
...
* link:../sas3/service-replace-drawer-ds460c.html["DS460C抽屉"]
