...
* link:../a250/bootmedia-replace-workflow-bmr.html["AFF A250（自动恢复）"]
* link:../a250/bootmedia-replace-workflow.html["AFF A250（手动恢复）"]
...
* link:../c250/bootmedia-replace-workflow.html["AFF C250 （手动恢复）"]
...
* link:../asa-c250/bootmedia-replace-workflow.html["ASA C250 （手动恢复）"]
...
* link:../fas500f/bootmedia-replace-workflow.html["FAS500f （手动恢复）"]
