...
summary: 通过卸下控制器模块、更换 NVMEM 电池并重新安装控制器模块来更换 FAS2600 系统中的 NVMEM 电池。 
---
= 更换 FAS2600 系统中的 NVMEM 电池
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
通过取下控制器模块、打开控制器模块、更换电池以及关闭并重新安装控制器模块，更换 FAS2600 系统中的 NVMEM 电池。

如果系统中的任何其他组件无法正常工作，请与技术支持联系。

link:https://youtu.be/dgEMcYxya5M["AFF FAS2600 NVMEM 电池更换视频"^]
