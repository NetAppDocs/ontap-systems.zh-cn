...
summary: 当平台向系统控制台记录指示驱动器发生故障的警告消息时，请热插拔 FAS2600 系统中的驱动器。操作员显示面板上的故障 LED 和故障驱动器上的故障 LED 均亮起。 
---
= 热插拔 FAS2600 系统中的驱动器
:allow-uri-read: 
:icons: font
...
[role="lead"]
当平台向系统控制台记录指示驱动器发生故障的警告消息时，请热插拔 FAS2600 系统中的驱动器。操作员显示面板上的故障 LED 和故障驱动器上的故障 LED 均亮起。
