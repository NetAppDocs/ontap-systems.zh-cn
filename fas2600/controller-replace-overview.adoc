...
summary: 在更换 FAS2600 系统中的控制器之前，请查看更换程序的先决条件，并为您的 ONTAP 操作系统版本选择正确的程序。 
---
= 在更换 FAS2600 系统中的控制器之前，请查看要求
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在更换 FAS2600 系统中的控制器之前，请查看更换程序的先决条件，并为您的 ONTAP 操作系统版本选择正确的程序。
