...
.步骤
. 使用动画或表格中的步骤完成控制器和交换机之间的布线：视频：edc42447-f721-4cbe-b080-ab0c0123a139[panopto、title="Cable a two-node switchless cluster"]
+
[cols="10,90"]
|===
| 步骤 | 对每个控制器模块执行 
...
.步骤
. 使用动画或表格中的步骤完成控制器和交换机之间的布线：视频：49e48140-4c5a-4395-a7d7-ab0c0123a10e[panopto、title="Cabling a Switched Cluster"]
+
[cols="10,90"]
|===
| 步骤 | 对每个控制器模块执行 
