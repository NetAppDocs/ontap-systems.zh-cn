...
[role="lead"]
当 AFF A800 系统中的 PCIe 卡出现故障或需要升级时，请更换该卡。更换过程包括断开电缆和 SFP 或 QSFP 模块、更换卡以及重新布线。
...
从目标提升板中 PCIe 卡的端口上卸下电缆以及所有 QSFP 和 SFP，从控制器模块中卸下提升板，卸下并更换 PCIe 卡，将提升板以及所有 QSFP 和 SFP 重新安装到端口上，然后重新连接端口，从而更换 PCIe 卡。
