...
[role="lead"]
这些是 AFF A800 存储系统在单个高可用性对中的选定规格。请访问 https://hwu.netapp.com["NetApp Hardware Universe"^]以获取此存储系统的完整规格。
...
* 工作温度/海拔/湿度：5°C 至 40°C（41°F 至 104°F），海拔最高可达 3048 米（10000 英尺）；相对湿度 8% 至 90%，无冷凝
