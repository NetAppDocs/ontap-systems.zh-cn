...
summary: 在 FAS9000 系统中完成控制器硬件更换并引导至维护模式后，验证替换控制器的低级系统配置，并根据需要重新配置系统设置。 
---
= 还原并验证 FAS9000 系统中的控制器配置
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在 FAS9000 系统中完成控制器硬件更换并引导至维护模式后，验证替换控制器的低级系统配置，并根据需要重新配置系统设置。
