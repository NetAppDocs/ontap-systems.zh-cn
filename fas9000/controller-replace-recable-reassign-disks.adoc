...
summary: 在 FAS9000 系统上重新连接存储并确认磁盘重新分配，以便更换后的控制器可以恢复正常操作。 
---
= 归还 FAS9000 系统中的控制器以恢复正常操作
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在 FAS9000 系统上重新连接存储并确认磁盘重新分配，以便更换后的控制器可以恢复正常操作。
...
--
.选项 2：双节点MetroCluster
--
=== 在双节点MetroCluster配置中的系统上手动重新分配系统 ID
