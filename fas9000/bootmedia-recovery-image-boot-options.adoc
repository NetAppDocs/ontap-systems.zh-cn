...
summary: 从恢复映像启动受损节点的步骤取决于系统是否处于双节点MetroCluster配置中。FAS9000系统仅支持手动启动介质恢复程序。 
---
= 在 FAS9000 系统上启动恢复映像
:allow-uri-read: 
:icons: font
...
[role="lead"]
在 FAS9000 系统中安装替换启动介质后，从 USB 驱动器启动恢复映像。启动受损控制器的过程取决于系统是否处于双节点 MetroCluster 配置。FAS9000 系统仅支持手动启动介质恢复过程。
