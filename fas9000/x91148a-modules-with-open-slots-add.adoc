...
summary: 将 X91148A 模块添加到 FAS9000 系统中的空模块插槽中，作为 100GbE NIC 或 NS224 存储架的存储模块。 
---
= 使用开放插槽将 X91148A 模块添加到 FAS9000 系统
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
将 X91148A 模块添加到 FAS9000 系统中的空模块插槽中，作为 100GbE NIC 或 NS224 存储架的存储模块。
