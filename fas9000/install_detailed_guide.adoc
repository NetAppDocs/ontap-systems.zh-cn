...
.步骤
. 使用动画或图形完成控制器与交换机之间的布线：
+
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=7a55b98a-e8b8-41d5-821f-ac5b0032ead0["为双节点无交换机集群布线"]
...
. 使用动画或图形完成控制器与交换机之间的布线：
+
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=6381b3f1-4ce5-4805-bd0a-ac5b0032f51d["有交换机集群布线"]
...
+
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=a312e09e-df56-47b3-9b5e-ab2300477f67["为 SAS 存储布线— ONTAP 9.7 及更早版本"]
...
+
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=61d23302-9526-4a2b-9335-ac5b0032eafd["为 SAS 存储布线— ONTAP 9.8 及更高版本"]
...
* 系统必须在插槽 3 和 / 或 7 中为每个控制器至少安装一个 X91148A 模块。此动画显示了此模块同时安装在插槽 3 和插槽 7 中。
...
.步骤
. 使用以下动画将具有两个 X91148A 存储模块的控制器连接到一个 NS224 驱动器架，或者使用此图将具有一个 X91148A 存储模块的控制器连接到一个 NS224 驱动器架。
+
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=6520eb01-87b3-4520-9109-ac5b0032ea4e["为单个 NS224 磁盘架布线— ONTAP 9.8 及更高版本"]
...
.步骤
. 使用以下动画或示意图将控制器连接到两个 NS224 驱动器架。
+
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=34098e39-73ad-45de-9af7-ac5b0032ea9a["为两个 NS224 磁盘架布线— ONTAP 9.8 及更高版本"]
...
+
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=95a29da1-faa3-4ceb-8a0b-ac7600675aa6["设置 SAS 或 NVMe 驱动器架 ID"]

. 将电源线插入控制器电源，然后将其连接到不同电路上的电源。
. 打开两个节点的电源开关。
+
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=bb04eb23-aa0c-4821-a87d-ab2300477f8b["打开控制器的电源"]
