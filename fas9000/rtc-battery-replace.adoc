...
summary: 更换 FAS9000 系统控制器模块中的实时时钟电池，以确保依赖精确时间同步的服务和应用程序继续正常运行。 
---
= 更换 FAS9000 系统中的 RTC 电池
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
更换 FAS9000 系统控制器模块中的实时时钟 (RTC) 电池，以确保依赖精确时间同步的服务和应用程序继续正常运行。
...
. 找到 RTC 电池。
+
image::../media/drw_9000_remove_rtc_battery.png[卸下或更换RTC电池]
