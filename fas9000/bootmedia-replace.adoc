...
summary: 通过卸下受损的控制器模块、安装替换引导介质并将引导映像传输到 USB 闪存驱动器，更换 FAS9000 系统中的引导介质。 
---
= 更换 FAS9000 系统中的启动介质
:allow-uri-read: 
:icons: font
...
[role="lead"]
通过卸下受损控制器模块、安装替换引导介质并将引导映像传输到 USB 闪存驱动器，更换 FAS9000 系统中的引导介质。FAS9000 系统仅支持手动引导介质恢复；不支持自动引导介质恢复。
