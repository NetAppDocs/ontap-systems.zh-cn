...
summary: 在 FAS9000 系统中更换控制器之前，请查看更换操作步骤的前提条件，并为您的 ONTAP 版本选择正确的操作步骤。 
---
= 在更换 FAS9000 系统中的控制器之前，请查看相关要求
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在 FAS9000 系统中更换控制器之前，请查看更换操作步骤的前提条件，并为您的 ONTAP 版本选择正确的操作步骤。
