...
summary: 检查环境变量后，您必须完成特定于启用了 Onboard Key Manager OKM、NetApp Storage Encryption NSE 或 NetApp Volume Encryption NVE 的系统的步骤。FAS9000 系统仅支持手动启动介质恢复过程。 
---
= 在 FAS9000 系统中的启动介质上恢复加密
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
通过完成适用于您的密钥管理器类型的步骤（例如板载密钥管理器 (OKM)），在 FAS9000 系统的替换启动介质上恢复加密。FAS9000 系统仅支持手动启动介质恢复过程。
