...
summary: 热插拔 FAS9000 系统中的缓存模块。从 ONTAP 9.4 开始，您可以将位于插槽 6 中 NVRAM10 模块前面的 NVMe SSD Flash Cache 模块热插拔为来自相同或不同受支持供应商的相同容量的缓存模块。 
---
= 热插拔 FAS9000 系统中的缓存模块
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
热插拔 FAS9000 系统中的缓存模块。从 ONTAP 9.4 开始，您可以将位于插槽 6 中 NVRAM10 模块前面的 NVMe SSD Flash Cache 模块热插拔为来自相同或不同受支持供应商的相同容量的缓存模块。
