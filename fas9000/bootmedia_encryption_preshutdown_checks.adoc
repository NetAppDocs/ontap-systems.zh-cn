...
** 如果命令输出中未显示 <lno-dur> ，并且系统运行的是 ONTAP 9.5 ，请转至  1: Check NVE or NSE on systems running ONTAP 9.5 and earlier。
** 如果命令输出中未显示 <lno-dur> ，并且系统运行的是 ONTAP 9.6 或更高版本，请转至  2: Check NVE or NSE on systems running ONTAP 9.6 and later。
