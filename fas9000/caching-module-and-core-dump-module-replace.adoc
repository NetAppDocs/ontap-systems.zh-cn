...
summary: '当系统注册了报告模块已离线的单个 AutoSupport (ASUP) 消息时，请更换 FAS9000 系统中的缓存模块或核心转储模块。如果未能更换，将导致性能下降。' 
---
= 更换 FAS9000 系统中的缓存模块或核心转储模块
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
当系统注册了报告模块已离线的单个 AutoSupport (ASUP) 消息时，请更换 FAS9000 系统中的缓存模块或核心转储模块。如果未能更换，将导致性能下降。
