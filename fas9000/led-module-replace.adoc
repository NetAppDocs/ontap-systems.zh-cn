...
summary: 在不中断服务的情况下更换 FAS9000 系统中的 LED USB 模块。该模块提供与控制台端口和系统状态的连接，无需工具即可更换。 
---
= 在 FAS9000 系统中热插拔 LED USB 模块
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在不中断服务的情况下更换 FAS9000 系统中的 LED USB 模块。该模块提供与控制台端口和系统状态的连接，无需工具即可更换。
