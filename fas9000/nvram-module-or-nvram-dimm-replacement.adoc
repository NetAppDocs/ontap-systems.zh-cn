...
summary: 更换 FAS9000 系统中出现故障的 NVRAM 模块或 NVRAM 模块内的 DIMM。由于系统 ID 源自 NVRAM 模块，因此更换该模块会将属于该系统的磁盘重新分配给新的系统 ID。 
---
= 更换 FAS9000 系统中的 NVRAM 模块或 NVRAM DIMM
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
更换 FAS9000 系统中出现故障的 NVRAM 模块或 NVRAM 模块内的 DIMM。由于系统 ID 源自 NVRAM 模块，因此更换该模块会将属于该系统的磁盘重新分配给新的系统 ID。
