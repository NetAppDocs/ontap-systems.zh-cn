...
summary: 关闭 AFF A700 存储系统中的控制器，以防止数据丢失，并在手动启动介质恢复过程中保持系统稳定性。 
---
= 在手动启动恢复过程中关闭 AFF A700 系统中的控制器
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
关闭 AFF A700 存储系统中的控制器，以防止数据丢失，并在手动启动介质恢复过程中保持系统稳定性。
...
完成 NVE 或 NSE 任务后，需要完成节点关闭。注意：如果您的系统处于双节点 MetroCluster 配置中，请不要使用此过程。
