...
summary: 当系统注册了越来越多的可更正的纠错代码或不可更正的 ECC 错误时，请更换 AFF A700 控制器模块中的 DIMM。未能更换有故障的 DIMM 可能会导致系统崩溃。 
---
= 更换 AFF A700 系统中的 DIMM
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
当存储系统遇到过多的可纠正 ECC 错误或无法纠正的 ECC 错误时，请更换 AFF A700 系统中的 DIMM。
