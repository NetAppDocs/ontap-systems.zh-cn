...
summary: 要热插拔包含 NVRAM10 电池的去级控制器电源模块，请找到故障的 DCPM 模块，将其从机箱中取出，然后安装更换的 DCPM 模块。 
---
= 热插拔 AFF A700 系统中的降级控制器电源模块 (DCPM)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
热插拔 AFF A700 系统中的降级控制器电源模块（DCPM），以更换故障模块，而不会中断服务。
...
+
image::../media/drw_9000_remove_nv_battery.png[卸下DCPM电池]
