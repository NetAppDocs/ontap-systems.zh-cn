...
summary: 要将 AFF A700 系统恢复到完全运行状态，请重新连接存储设备，必要时恢复 NetApp Storage Encryption 配置，并为新控制器安装许可证。 
---
= 完成 AFF A700 系统的控制器更换
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
通过重新连接存储、恢复 NetApp 存储加密配置（如有必要）以及为新控制器安装许可证，完成 AFF A700 系统的控制器更换。
