...
---
= 连接 AFF A20、AFF A30 或 AFF A50 硬件以实现网络和存储连接
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:../media/drw_isi_a20_switched_2p_25gbe_cabling_ieops-2019.svg["使用一个 25 GbE IO 模块的 a20 交换集群布线图"]
...
.AFF A20、AFF A30 或 AFF A50，带一个 4 端口 10/25 GbE I/O 模块
...
.带有一个 4 端口 64 Gb/s FC I/O 模块的 AFF A20、AFF A30 或 AFF A50
