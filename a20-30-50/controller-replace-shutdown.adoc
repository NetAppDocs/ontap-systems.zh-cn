...
summary: 在更换控制器时、关闭AFF A20、AFF A30或AFF A50存储系统中的受损控制器、以防止数据丢失并确保系统稳定性。 
---
= 在更换前关闭 AFF A20、AFF A30 或 AFF A50 系统中受损的控制器
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在更换控制器时、关闭AFF A20、AFF A30或AFF A50存储系统中的受损控制器、以防止数据丢失并确保系统稳定性。
