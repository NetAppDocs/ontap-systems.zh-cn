...
summary: 当驱动器出现故障或需要升级时，请更换AFF A20、 AFF A30 或AFF A50 存储系统中的驱动器。更换过程包括识别故障驱动器、安全移除它以及安装新驱动器以确保持续的数据访问和系统性能。 
---
= 更换 AFF A20、AFF A30 或 AFF A50 系统中的驱动器
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
当驱动器出现故障或需要升级时，请更换AFF A20、 AFF A30 或AFF A50 存储系统中的驱动器。更换过程包括识别故障驱动器、安全移除它以及安装新驱动器以确保持续的数据访问和系统性能。
