...
summary: 在 AFF A20、AFF A30 或 AFF A50 存储系统中的 AC 或 DC 电源装置发生故障或出现问题时进行更换，确保系统继续接收稳定运行所需的电源。更换过程包括断开有故障的 PSU 与电源的连接，拔下电源线，更换有故障的 PSU，然后将其重新连接到电源。 
---
= 热插拔 AFF A20、AFF A30 或 AFF A50 系统中的电源设备
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
当AFF A20、 AFF A30 或AFF A50 存储系统中的交流或直流电源装置 (PSU) 发生故障或故障时，请更换该电源装置，以确保系统继续接收稳定运行所需的电力。更换过程包括将故障的 PSU 与电源断开、拔下电源线、更换故障的 PSU，然后将其重新连接到电源。
