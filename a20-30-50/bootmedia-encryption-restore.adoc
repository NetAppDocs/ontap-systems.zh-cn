...
summary: 在AFF A20、AFF A30或AFF A50系统中的替代启动介质上恢复加密、以确保持续提供数据保护。更换过程包括验证密钥可用性、重新应用加密设置以及确认对数据的安全访问。 
---
= 恢复启动介质上的加密- AFF A20、AFF A30和AFF A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在AFF A20、AFF A30或AFF A50系统中的替代启动介质上恢复加密、以确保持续提供数据保护。更换过程包括验证密钥可用性、重新应用加密设置以及确认对数据的安全访问。
