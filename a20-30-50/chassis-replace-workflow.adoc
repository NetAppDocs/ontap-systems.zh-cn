...
summary: 通过查看更换要求、关闭控制器、更换机箱以及验证系统运行情况、开始更换AFF A20、AFF A30或AFF A50存储系统的机箱。 
---
= AFF A20、AFF A30 和 AFF A50 机箱更换工作流程
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
通过查看更换要求、关闭控制器、更换机箱以及验证系统运行情况、开始更换AFF A20、AFF A30或AFF A50存储系统的机箱。
...
[role="quick-margin-para"]
更换机箱包括将驱动器、驱动器空白挡板、控制器（带电源）和挡板从受损机箱移动到新机箱。然后，将受损机箱更换为相同型号的新机箱。
