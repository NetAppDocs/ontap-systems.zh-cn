...
[role="lead"]
这些选择规格描述了在单个高可用性对中配置的 AFF A50 存储系统。请访问 NetApp Hardware Universe (HWU) 以获取此系统的完整规格。
...
* 类型：NAS；HA 对：12；原始容量：48.5 PB / 43.0 PiB；最大内存：3072 GB
* 类型：SAN；HA 对：6；原始容量：24.2 PB / 21.5 PiB；最大内存：1536 GB
* 类型：HA 对；原始容量：4.0 PB / 3.6 PiB；最大内存：256.0000
