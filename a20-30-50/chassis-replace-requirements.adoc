...
summary: 在更换 AFF A20、AFF A30 或 AFF A50 存储系统的机箱之前，请验证您是否满足成功更换所需的必要条件。这包括验证系统中的所有其他组件是否正常运行、验证您是否拥有正确的替换机箱，以及验证您是否具备必要的工具。 
---
= 在更换 AFF A20、AFF A30 或 AFF A50 机箱之前查看相关要求
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在更换 AFF A20、AFF A30 或 AFF A50 存储系统的机箱之前，请验证您是否满足成功更换所需的必要条件。这包括验证系统中的所有其他组件是否正常运行、验证您是否拥有正确的替换机箱，以及验证您是否具备必要的工具。
