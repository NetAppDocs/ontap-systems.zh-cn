...
summary: 在更换AFF A20、 AFF A30 或AFF A50 存储系统的机箱之前，请确保满足成功更换的必要要求。这包括验证系统中的所有其他组件是否正常运行，验证您是否拥有正确的替换底盘以及必要的工具。 
---
...
[role="lead"]
在更换AFF A20、 AFF A30 或AFF A50 存储系统的机箱之前，请确保满足成功更换的必要要求。这包括验证系统中的所有其他组件是否正常运行，验证您是否拥有正确的替换底盘以及必要的工具。
