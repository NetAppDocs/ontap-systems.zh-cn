...
summary: 如果硬件故障需要更换AFF A20、AFF A30或AFF A50系统中的控制器。更换过程包括移除受损控制器、将组件移至更换控制器、安装更换控制器并重新启动它。 
---
= 更换控制器- AFF A20、AFF A30和AFF A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
如果硬件故障需要更换AFF A20、AFF A30或AFF A50系统中的控制器。更换过程包括移除受损控制器、将组件移至更换控制器、安装更换控制器并重新启动它。
...
.下一步是什么？
在更换受损AFF A20、AFF A30或AFF A50控制器后，您需要link:controller-replace-system-config-restore-and-verify.html["还原系统配置"]。
