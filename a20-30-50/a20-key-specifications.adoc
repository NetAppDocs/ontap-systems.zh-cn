...
[role="lead"]
这些选择规格描述了配置在单个高可用性对中的 AFF A20 存储系统。请访问 NetApp Hardware Universe (HWU) 以获取此系统的完整规格。
...
* 类型：NAS；HA 对：3；原始容量：12.1 PB / 10.8 PiB；最大内存：384 GB
* 类型：SAN；HA 对：3；原始容量：12.1 PB / 10.8 PiB；最大内存：384 GB
