...
summary: 在更换机箱时、关闭AFF A20、AFF A30或AFF A50存储系统中的控制器、以防止数据丢失并确保系统稳定性。 
---
= 关闭 AFF A20、AFF A30 或 AFF A50 控制器以更换机箱
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在更换机箱时、关闭AFF A20、AFF A30或AFF A50存储系统中的控制器、以防止数据丢失并确保系统稳定性。
