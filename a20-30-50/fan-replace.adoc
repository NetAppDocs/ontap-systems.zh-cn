...
summary: 当风扇出现故障或无法有效运行时，请更换AFF A20、 AFF A30 或AFF A50 存储系统中的风扇模块，因为这会影响系统冷却和整体性能。更换过程包括关闭控制器、移除控制器、更换风扇、重新安装控制器以及将故障部件退回给NetApp。 
---
= 热插拔 AFF A20、AFF A30 或 AFF A50 系统中的风扇模块
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
当风扇出现故障或无法有效运行时，请更换AFF A20、 AFF A30 或AFF A50 存储系统中的风扇模块，因为这会影响系统冷却和整体性能。更换过程包括关闭控制器、移除控制器、更换风扇、重新安装控制器以及将故障部件退回给NetApp。
