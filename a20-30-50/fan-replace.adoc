...
summary: 如果风扇出现故障或运行效率低下、请更换AFF A20、AFF A30或AFF A50系统中的风扇模块、因为这会影响系统散热和整体性能。更换过程包括关闭控制器、卸下控制器、更换风扇、重新安装控制器以及将故障部件退回NetApp。 
---
= 更换风扇模块- AFF A20、AFF A30和AFF A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
如果风扇出现故障或运行效率低下、请更换AFF A20、AFF A30或AFF A50系统中的风扇模块、因为这会影响系统散热和整体性能。更换过程包括关闭控制器、卸下控制器、更换风扇、重新安装控制器以及将故障部件退回NetApp。
