...
summary: 当硬件故障需要更换AFF A20、 AFF A30 或AFF A50 存储系统的机箱时。更换过程包括移除控制器、移除驱动器、安装更换机箱以及重新安装机箱组件。 
---
= 更换 AFF A20、AFF A30 或 AFF A50 系统中的机箱
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
当硬件故障需要更换AFF A20、 AFF A30 或AFF A50 存储系统的机箱时。更换过程包括移除控制器、移除驱动器、安装更换机箱以及重新安装机箱组件。
...
.下一步是什么？
在更换受损机箱并将组件重新安装到其中后，您需要link:chassis-replace-complete-system-restore-rma.html["完成机箱更换"]。
