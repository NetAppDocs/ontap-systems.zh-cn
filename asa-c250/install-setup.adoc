...
summary: 使用快速步骤、视频步骤或详细步骤安装和设置 ASA C250 存储系统。 
---
= 选择如何安装 ASA C250 存储系统
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
使用快速步骤、视频步骤或详细步骤安装和设置 ASA C250 存储系统。

* link:../asa-c250/install-quick-guide.html["快速步骤"]
+
一份可打印的 PDF 分步说明，其中包含指向其他内容的实时链接。

* link:../asa-c250/install-videos.html["视频步骤"]
+
视频分步说明。

* link:../asa-c250/install-detailed-guide.html["详细步骤"]
+
