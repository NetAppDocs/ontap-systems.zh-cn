...
summary: 通过查看更换要求、检查加密状态、关闭控制器、更换引导介质、引导恢复映像、恢复加密和验证系统功能，开始更换 ASA C250 存储系统中的引导介质。 
---
= 使用手动引导恢复过程的 ASA C250 系统的引导介质更换工作流程
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
通过查看更换要求、检查加密状态、关闭控制器、更换引导介质、引导恢复映像、恢复加密和验证系统功能，开始更换 ASA C250 存储系统中的引导介质。
