...
summary: 要更换 ASA C250 系统中的 NVMEM 电池，您必须从系统中取出控制器模块，打开它，更换电池，然后关闭并重新安装控制器模块。 
---
= 更换 ASA C250 系统中的 NVMEM 电池
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
要更换 ASA C250 系统中的 NVMEM 电池，您必须从系统中取出控制器模块，打开它，更换电池，然后关闭并重新安装控制器模块。
