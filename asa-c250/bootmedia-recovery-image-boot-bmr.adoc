...
summary: 在 ASA C250 系统中安装新的启动介质设备后，您可以启动自动启动介质恢复过程以从伙伴节点恢复配置。 
---
= 使用自动启动恢复过程还原 ASA C250 系统上的启动映像
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在您的 ASA C250 系统中安装新的启动介质设备后，您可以启动自动启动介质恢复过程以从伙伴节点恢复配置。在恢复过程中，系统检查加密是否已启用，并确定正在使用的密钥加密类型。如果启用了密钥加密，系统将引导您完成恢复密钥的相应步骤。
