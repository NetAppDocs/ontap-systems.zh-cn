...
summary: 当系统注册越来越多的可纠正纠错代码或不可纠正的 ECC 错误时，请更换 ASA C250 系统中的 DIMM。未能更换有故障的 DIMM 可能会导致系统崩溃。 
---
= 更换 ASA C250 系统中的 DIMM 以修复内存错误
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
当系统注册越来越多的可纠正纠错代码或不可纠正的 ECC 错误时，请更换 ASA C250 系统中的 DIMM。未能更换有故障的 DIMM 可能会导致系统崩溃。
