...
+
https://netapp.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=db161030-298a-4ae4-b902-adf2000e2aa4["动画—更换 DIMM"^]
...
+
https://netapp.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=099237f3-d7f2-4749-86e2-adf2000df53c["动画—安装控制器"^]
...
+
*** 如果显示一条提示，警告您在 HA 配置中进入维护模式时，必须确保运行正常的节点保持关闭状态。
