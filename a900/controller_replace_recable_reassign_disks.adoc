...
.步骤
. 重新对系统进行布线。
. Verify that the cabling is correct by using https://["Active IQ Config Advisor"^]。
+
...
+
有关详细信息，请参见 https://["在四节点 MetroCluster 配置中，磁盘所有权会在 HA 接管和 MetroCluster 切换期间发生更改"^] 主题。
