...
[role="lead"]
从准备现场到启动 ONTAP 集群，请按照这些详细的分步说明安装 AFF A900 存储系统。
...
+
NS224 磁盘架预设为磁盘架 ID 00 和 01。如果要更改磁盘架 ID，则必须创建一个工具以插入按钮所在的孔中。有关详细说明，请参阅 link:../ns224/change-shelf-id.html["更改磁盘架 ID — NS224 磁盘架"]。
