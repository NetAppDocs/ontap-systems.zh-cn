...
sidebar: sidebar 
keywords: AFF A900 
summary: 要热插拔包含 NVRAM11 电池的去级控制器电源模块，请找到故障的 DCPM 模块，将其从机箱中取出，然后安装更换的 DCPM 模块。 
---
= 更换 AFF A900 系统中包含 NVRAM11 电池的 DCPM 模块
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
当 AFF A900 系统中的转储控制器电源模块 (DCPM) 发生故障时，对其进行热插拔。DCPM 包含 NVRAM11 电池，必须在拆卸后五分钟内更换，以防止丢失数据保护。
...
+
image::../media/drw_a900_remove_NV_battery.svg[取出NV电池]
