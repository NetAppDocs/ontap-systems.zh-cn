...
X66240A-5 （ 112-00600 ）， 5 米
 a| 
image::../media/oie_cable_sfp_gbe_copper.svg[GbE铜缆SFP]
 a| 
网络缆线
...
X66100-5 （ 112-00544 ）， 5 米
 a| 
image::../media/oie_cable100_gbe_qsfp28.svg[GbE铜缆SFP]
 a| 
以太网数据，集群网络
...
X66033A （ 112-00438 ）， 3 米
 a| 
image::../media/oie_cable_fiber_lc_connector.svg[LC光纤连接器]
 a| 
FC 光纤网络
...
X6562-R6 （ 112-00196 ）， 5 米
 a| 
image::../media/oie_cable_rj45.svg[RJ-45电缆连接器]
 a| 
管理网络和以太网数据
...
不适用
 a| 
image::../media/oie_cable_micro_usb.svg[微型USB连接器]
 a| 
...
不适用
 a| 
image::../media/oie_cable_power.svg[电源电缆连接器]
 a| 
启动系统
...
| 步骤 | 在每个控制器上执行 
 ...
 a| 
image::../media/oie_legend_icon_1_lg.svg[标注图标1]
 a| 
使用缆线连接集群互连端口：
...
image::../media/oie_cable100_gbe_qsfp28.svg[100 Gb连接器]



 a| 
image::../media/oie_legend_icon_2_lp.svg[标注图标2]
 a| 
使用缆线连接控制器管理（扳手）端口。
...
image::../media/oie_cable_rj45.svg[RJ-45电缆连接器]
 ...
 a| 
image::../media/oie_legend_icon_3_o.svg[标注图标3]
 a| 
使用缆线连接 25 GbE 网络交换机：
...
image::../media/oie_cable100_gbe_qsfp28.svg[100 GbE缆线连接器]



 a| 
image:../media/oie_legend_icon_4_dr.svg["标注图标4"]
 a| 
...
image:../media/oie_cable_sfp_gbe_copper.svg["GbE铜缆SFP"]
 ...
 a| 
image::../media/oie_legend_icon_5_lp.png[标注图标5]
 a| 
** 将缆线固定到缆线管理臂上(未显示)。
** 将电源线连接到PSU并将其连接到不同的电源(未显示)。PSU 1和3为所有A侧组件供电、而PSU2和PSU4则为所有B侧组件供电。


image:../media/oie_cable_power.svg["电源线"]
...
image:../media/oie_cable100_gbe_qsfp28.svg["100 GbE缆线"]



 a| 
image:../media/oie_legend_icon_2_lo.svg["标注图标2"]
 a| 
使用缆线连接控制器管理（扳手）端口。
...
image::../media/drw_a900fas9500_power_icon_IEOPS-1142.svg[DRW a900FAS9500电源图标IEOPS 1142.]
...
image::../media/oie_cable_pull_tab_down.svg[电缆拉片方向]
...
| 步骤 | 在每个控制器上执行 
 ...
 a| 
image::../media/oie_legend_icon_1_mb.svg[标注1]
 a| 
** 将控制器 A 端口 E2A 连接到磁盘架上 NSM A 上的端口 e0a 。
** 将控制器 A 端口 e10b 连接到磁盘架上 NSM B 上的端口 e0b 。


image::../media/oie_cable100_gbe_qsfp28.svg[100 GbE QSFPConnector]
...
100 GbE 缆线
 ...
 a| 
image::../media/oie_legend_icon_2_lo.svg[标注2]
 a| 
...
| 步骤 | 在每个控制器上执行 
 ...
 a| 
image::../media/oie_legend_icon_1_mb.svg[标注图标1]
 a| 
...
磁盘架端盖
 ...
 a| 
image::../media/legend_icon_02.png[标注图标2]
 a| 
磁盘架面板
 ...
 a| 
image::../media/legend_icon_03.png[标注图标3]
 a| 
磁盘架ID LED
 ...
 a| 
image::../media/legend_icon_04.png[标注图标4]
 a| 
磁盘架ID设置按钮
