...
. 记录控制器的系统序列号。
+
image:drw_ssn_label.svg["显示编号位置的系统序列号示例"]
...
X66240A-5 （ 112-00600 ）， 5 米
 a| 
image:oie_cable_sfp_gbe_copper.svg["宽=85个"]
 a| 
网络缆线
...
X66100-5 （ 112-00544 ）， 5 米
 a| 
image:oie_cable100_gbe_qsfp28.svg["宽=85个"]
 a| 
以太网数据，集群网络
...
X66033A （ 112-00438 ）， 3 米
 a| 
image:oie_cable_fiber_lc_connector.svg["宽=85个"]
 a| 
FC 光纤网络
...
X6562-R6 （ 112-00196 ）， 5 米
 a| 
image:oie_cable_rj45.svg["宽=85个"]
 a| 
管理网络和以太网数据
...
不适用
 a| 
image:oie_cable_micro_usb.svg["宽=85个"]
 a| 
...
不适用
 a| 
image:oie_cable_power.svg["宽=85个"]
 a| 
启动系统
...
+
image:drw_9500_lifting_icon.svg["举重注意标签"]

. 连接缆线管理设备（如图所示）。
+
image:drw_9500_cable_management_arms.svg["安装缆线管理ARM"]
...
image:drw_a900_controller_in _chassis_ID_IEOPS-856.svg["典型集群配置"]
...
image:oie_cable_pull_tab_up.svg["电缆拉片方向"]
...
+
image:drw_a900_tnsc_network_cabling_IEOPS-933.svg["双节点无交换机网络布线"]
...
| 步骤 | 在每个控制器上执行 
 ...
 a| 
image:oie_legend_icon_1_lg.svg["宽度=30个"]
 a| 
使用缆线连接集群互连端口：
...
image:oie_cable100_gbe_qsfp28.svg["宽=85个"]
 ...
 a| 
image:oie_legend_icon_2_lp.svg["宽度=30个"]
 a| 
使用缆线连接控制器管理（扳手）端口。
...
image:oie_cable_rj45.svg["宽=85个"]
 ...
 a| 
image:oie_legend_icon_3_o.svg["宽度=30个"]
 a| 
使用缆线连接 25 GbE 网络交换机：
...
image:oie_cable100_gbe_qsfp28.svg["宽=85个"]
 ...
 a| 
image:oie_legend_icon_4_dr.svg["宽度=30个"]
 a| 
使用缆线连接 32 Gb FC 连接：
...
image:drw_a900fas9500_power_source_icon_IEOPS-1142.svg["宽度=200个"]
...
+
image:drw_a900_switched_network_cabling_IEOPS-934.svg["宽度= 500像素"]
...
image:oie_cable_pull_tab_down.svg["宽度=200个"]
...
+
image:drw_a900_NS224_one shelf_cabling_IEOPS-937.svg["宽度= 500像素"]
...
| 步骤 | 在每个控制器上执行 
 ...
 a| 
image:oie_legend_icon_1_mb.svg["宽度=30个"]
 a| 
** 将控制器 A 端口 E2A 连接到磁盘架上 NSM A 上的端口 e0a 。
** 将控制器 A 端口 e10b 连接到磁盘架上 NSM B 上的端口 e0b 。


image:oie_cable100_gbe_qsfp28.svg["宽度=50个"]
...
100 GbE 缆线
 ...
 a| 
image:oie_legend_icon_2_lo.svg["宽度=30个"]
 a| 
...
+
image:drw_a900_NS224_line_art_two shelf_cabling_IEOPS-1147.svg["宽度= 500像素"]

+
image:drw_a900_NS224_two_shelf_cabling_IEOPS-938.svg["宽度= 500像素"]
...
+
image:drw_a900_oie_change_ns224_shelf_ID_IEOPS-836.svg["宽度= 500像素"]
...
+
image:drw_a900_power-on_IEOPS-941.svg["宽度= 500像素"]
...
+
image:dwr_laptop_to_switch_only.svg["宽度= 500像素"]

. 选择列出的 ONTAP 图标以发现：
+
image:drw_autodiscovery_controler_select.svg["宽度= 500像素"]
...
+
image:drw_A900_cable_console_switch_controller_IEOPS-953.svg["宽度= 500像素"]
