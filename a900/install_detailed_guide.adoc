...
image::../media/drw_a900_controller_in _chassis_ID_IEOPS-856.svg[机箱ID为IEOPS 856的DRW a900控制器]
...
+
image::../media/drw_a900_tnsc_network_cabling_IEOPS-933.svg[DRW a900 tnsc网络布线IEOPS 933]
...
+
NS224 磁盘架已预先设置为磁盘架 ID 00 和 01 。If you want to change the shelf IDs, you must create a tool to insert into the hole where button is located.请参见 https://["更改磁盘架 ID — NS224 磁盘架"] 有关详细说明、请参见。
