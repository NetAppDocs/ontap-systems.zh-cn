...
summary: NVRAM 模块包括 NVRAM11 和 DIMM 以及每个 NVRAM 模块最多两个 NVMe SSD Flash Cache 模块。 
---
= 更换 AFF A900 系统中的 NVRAM 模块或 NVRAM DIMM
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
当 AFF A900 系统中的 NVRAM 模块发生故障或 DIMM 出现故障时，请更换 NVRAM 模块或 NVRAM DIMM。更换过程包括从机箱中卸下 NVRAM 模块、更换故障组件，然后重新安装该模块。
...
+
image::../media/drw_a900_move-remove_NVRAM_module.svg[卸下NVRAM模块]
...
+
image::../media/drw_a900_remove_NVRAM_module_contents.svg[删除NVRAM模块内容]
