...
summary: 开始更换 AFF A900 存储系统中的启动介质。工作流程包括审核更换要求、检查加密状态、关闭控制器、更换启动介质、启动恢复映像、恢复加密和验证系统功能。 
---
= 使用手动启动恢复过程的 AFF A900 系统的启动介质更换工作流程
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
开始更换 AFF A900 存储系统中的启动介质。工作流程包括审核更换要求、检查加密状态、关闭控制器、更换启动介质、启动恢复映像、恢复加密和验证系统功能。
