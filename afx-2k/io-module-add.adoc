...
summary: 将 I/O 模块添加到 AFX 2K 存储系统，以增强网络连接并扩展系统处理数据流量的能力。 
---
= 向 AFX 2K 系统添加 I/O 模块以增强网络连接
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
将 I/O 模块添加到 AFX 2K 存储系统，以增强网络连接并扩展系统处理数据流量的能力。

当有空插槽可用或所有插槽都已完全填充时，您可以将 I/O 模块添加到 AFX 2K 存储系统。
...
.开始之前
* 请检查 https://hwu.netapp.com["NetApp Hardware Universe"^]以确保新的 I/O 模块与您的存储系统和 ONTAP 版本兼容。
