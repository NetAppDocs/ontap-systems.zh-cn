...
summary: 当硬件故障需要时，请更换 afx 2k 存储系统的机箱。更换过程包括从机箱前部卸下控制器，卸下电源单元、NVRAM12、I/O 模块和空白挡板以及系统管理模块，然后安装更换机箱，并重新安装机箱组件。 
---
= 更换机箱 - AFX 2K
:allow-uri-read: 
:icons: font
...
[role="lead"]
当硬件故障需要时，请更换 AFX 2K 存储系统的机箱。更换过程包括卸下控制器、I/O 卡、NVRAM12 模块、系统管理模块和电源装置 (PSU)、安装更换机箱以及重新安装机箱组件。
...
+
image::../media/drw_afx_2k_psu_remove_replace_ieops-2882.svg[移除或更换 PSU]
...
== 步骤 2：卸下 I/O 卡、NVRAM12、NVRAM12-EX 和系统管理模块

. 从机箱中卸下目标 I/O 模块：
+
image:../media/drw_afx_2k_io_remove_replace_ieops-2878.svg["卸下I/O模块"]
...
+
image::../media/drw_nvram1_remove_only_ieops-2574.svg[卸下 NVRAM12 模块]
...
+
.. 抓住模块上的手柄并按下锁定凸轮按钮。
.. 从机箱中拉出 NVRAM12-EX 模块，同时用另一只手支撑模块底部。
+
...
+
image::../media/drw_afx_2k_sys_mgmt_remove_replace_ieops-2880.svg[系统管理删除]
...
.下一步是什么？
更换损坏的 AFX 2K 机箱并重新安装其组件后，请完成link:chassis-replace-complete-system-restore-rma.html["底盘更换"]。
