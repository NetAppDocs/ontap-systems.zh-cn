...
summary: 当 AFX 2K 存储系统中的控制器受损时，请将其关闭。在进行维护或组件更换之前，安全关闭控制器至关重要，以防止数据丢失并确保系统稳定性。 
---
= 在更换前关闭 AFX 2K 存储系统中受损的控制器
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
关闭 AFX 2K 存储系统中受损的控制器，以防止数据丢失，并确保更换控制器时的系统稳定性。
...
.下一步是什么？
关闭控制器后，link:controller-replace-move-hardware.html["更换控制器"] 。
