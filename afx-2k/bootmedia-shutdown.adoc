...
summary: 关闭 AFX 2K 存储系统中受损的控制器，以防止数据丢失，并确保更换启动介质时的系统稳定性。 
---
= 在自动启动恢复过程中关闭 AFX 2K 存储系统中的控制器
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
关闭 AFX 2K 存储系统中受损的控制器，以防止数据丢失，并确保更换启动介质时的系统稳定性。
...
.下一步是什么？
关闭控制器后，link:bootmedia-replace.html["更改启动媒体"] 。
