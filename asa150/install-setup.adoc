...
[role="lead"]
选择安装 ASA A150 存储系统的首选格式：详细的分步说明、快速图形指南或视频说明。

* link:../asa150/install-quick-guide.html["快速步骤"]
+
一份可打印的 PDF 分步说明，其中包含指向其他内容的实时链接。

* link:../asa150/install-videos.html["视频步骤"]
+
视频分步说明。

* link:../asa150/install-detailed-guide.html["详细步骤"]
+
