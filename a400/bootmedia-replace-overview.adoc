...
summary: 启动介质存储系统在启动时使用的主要和辅助系统文件集。 
---
= 查看在 AFF A400 系统中更换启动介质的要求
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在更换 AFF A400 系统中的启动介质之前，请确认您符合成功更换的必要要求。这包括准备一个格式化为 FAT32 且具有足够存储空间的 USB 闪存驱动器以存储 ONTAP 恢复映像，以及确定更换操作是无中断还是中断性的。
