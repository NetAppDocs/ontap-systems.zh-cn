...
您可以使用以下动画，绘图或写入步骤来更换 PCIe 卡。

https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=84339f87-321c-400e-985e-aae10182cd24["更换 PCIe 卡"]
...
您可以使用以下动画，绘图或写入步骤来更换夹层卡。

https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=4e00f5b1-8ca5-4cd6-9881-aadb01578e52["更换夹层卡"]
