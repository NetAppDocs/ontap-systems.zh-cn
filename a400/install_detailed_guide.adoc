...
+
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=48552ddf-0925-4f88-8e93-ab1b00666489["双节点无交换机集群布线"]
...
. 使用动画或图形完成控制器与交换机之间的布线：
+
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=8fefba75-f395-4cf2-ba3c-ab1b00665870["有交换机集群布线"]
...
.步骤
. 使用以下动画或图形将控制器连接到一个驱动器架。
+
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=48d68897-c91d-47dc-b4b0-ab1b0066808a["使用缆线将控制器连接到一个 NS224 驱动器架"]
...
.步骤
. 使用以下动画或图形将控制器连接到两个驱动器架。
+
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=5501c7bf-8b74-49e8-8067-ab1b00668804["使用缆线将控制器连接到两个 NS224 驱动器架"]
...
. 使用下图将控制器连接到两个驱动器架。
+
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=cbb0280e-708d-4365-92b6-ab1b006677ef["使用缆线将控制器连接到 SAS 驱动器架"]
