...
summary: 在双节点 MetroCluster 配置中完成 FRU 更换后，执行 MetroCluster 切回操作以将配置恢复到其正常运行状态，以前受损站点上的同步源存储虚拟机现在处于活动状态，并从本地磁盘池提供数据。 
---
= 在 AFF A400 系统中切换回双节点 MetroCluster 配置中的聚合
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
