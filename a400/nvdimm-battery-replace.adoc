...
[role="lead"]
当 AFF A400 系统中的 NVDIMM 电池开始失去电量或出现故障时，请将其更换。更换过程包括卸下控制器模块、更换电池和重新安装控制器模块。
...
image::../media/drw_A400_nvdimm-batt_IEOPS-1004.svg[更换NVDIMM电池]
