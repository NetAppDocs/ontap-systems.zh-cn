...
summary: 如果检测到过多可更正或不可更正的错误、请更换AFF C80系统中的DIMM。这些问题通常由单个DIMM故障引起、可能会阻止存储系统启动ONTAP。 
---
= 更换DIMM - AFF C80
:allow-uri-read: 
:icons: font
...
[role="lead"]
如果检测到过多可更正或不可更正的错误、请更换AFF C80系统中的DIMM。这些问题通常由单个DIMM故障引起、可能会阻止存储系统启动ONTAP。
