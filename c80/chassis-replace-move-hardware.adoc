...
summary: '如果硬件故障需要更换AFF C80系统的机箱。更换过程包括卸下控制器和电源设备(PSU)、卸下驱动器、安装更换机箱以及重新安装机箱组件。' 
---
= 更换机箱- AFF C80
:allow-uri-read: 
:icons: font
...
[role="lead"]
当您的AFF C80 系统出现硬件故障需要更换机箱时，请更换机箱。更换过程包括移除控制器和电源装置 (PSU)、移除驱动器、安装更换机箱以及重新安装机箱组件。
