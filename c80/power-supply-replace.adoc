...
summary: 当 AFF C80 系统中的交流或直流电源单元出现故障或变得有缺陷时，请进行更换，以确保您的系统继续获得稳定运行所需的电源。更换过程包括从电源断开故障电源单元，拔下电源线，更换故障单元，然后将其重新连接到电源。 
---
= 热插拔 AFF C80 存储系统中的电源单元
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
AFF C80系统中的交流或直流电源设备(PSU)出现故障或出现故障时、请予以更换、以确保系统继续获得稳定运行所需的电源。更换过程包括断开故障PSU与电源的连接、拔下电源线、更换故障PSU、然后将其重新连接到电源。
