...
summary: 关闭 ASA A20、ASA A30 或 ASA A50 存储系统中的控制器，以防止数据丢失并确保更换启动介质时的系统稳定性。 
---
= 在自动启动恢复过程中关闭 ASA A20、ASA A30 或 ASA A50 系统中的控制器
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
关闭 ASA A20、ASA A30 或 ASA A50 存储系统中的控制器，以防止数据丢失并确保更换启动介质时的系统稳定性。
...
.下一步行动
关闭控制器后，您link:bootmedia-replace-bmr.html["更换启动介质"]。
