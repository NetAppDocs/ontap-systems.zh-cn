...
summary: 在更换机箱时、关闭ASA A20、ASA A30或ASA A50存储系统中的控制器、以防止数据丢失并确保系统稳定性。 
---
= 关闭 ASA A20、ASA A30 或 ASA A50 控制器以更换机箱
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在更换机箱时、关闭ASA A20、ASA A30或ASA A50存储系统中的控制器、以防止数据丢失并确保系统稳定性。
