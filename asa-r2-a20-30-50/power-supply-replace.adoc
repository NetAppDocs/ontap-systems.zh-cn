...
summary: '当ASA A20、 ASA A30 或ASA A50 存储系统中的交流或直流电源装置 (PSU) 发生故障或故障时，请更换该装置，以确保系统继续接收稳定运行所需的电力。更换过程包括将故障的 PSU 与电源断开、拔下电源线、更换故障的 PSU，然后将其重新连接到电源。' 
---
= 热插拔电源 - ASA A20、 ASA A30 和ASA A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
当ASA A20、 ASA A30 或ASA A50 存储系统中的交流或直流电源装置 (PSU) 发生故障或故障时，请更换该装置，以确保系统继续接收稳定运行所需的电力。更换过程包括将故障的 PSU 与电源断开、拔下电源线、更换故障的 PSU，然后将其重新连接到电源。
