...
summary: 当硬件故障需要更换ASA A20、 ASA A30 或ASA A50 存储系统的机箱时。更换过程包括移除控制器、移除驱动器、安装更换机箱以及重新安装机箱组件。 
---
= 更换 ASA A20、ASA A30 或 ASA A50 系统中的机箱
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
当硬件故障需要更换ASA A20、 ASA A30 或ASA A50 存储系统的机箱时。更换过程包括移除控制器、移除驱动器、安装更换机箱以及重新安装机箱组件。
