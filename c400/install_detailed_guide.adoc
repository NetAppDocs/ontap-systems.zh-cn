...
+
image::../media/drw_c400_TNSC-network-cabling.png[DRW C400 TNSC网络布线]
...
+
image::../media/drw_c400_switched_network_cabling.png[DRW C400交换网络布线]
...
+
image::../media/drw_c400_one_ns224_shelves.png[DRW C400一个nss224磁盘架]
...
+
image::../media/drw_c400_two_ns224_shelves.png[DRW C400两个nss224磁盘架]
