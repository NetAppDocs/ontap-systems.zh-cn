...
[role="lead"]
通过断开 AFF C400 存储系统中卡上的电缆和 SFP/QSFP 模块，更换故障卡并重新布线，来更换 PCIe 或夹层卡。
...
NOTE: 完全拧紧夹层卡的指旋螺钉。如果松动，则可能无法检测到端口 e0e 至 e0h，LED 可能连续闪烁，日志可能显示"不支持电缆"错误。
