...
[role="lead"]
使用详细指南安装和设置 AFF C400 存储系统，该指南提供了从机架安装和布线到初始系统启动的分步说明。
...
image:../media/oie_cable_fiber_lc_connector.png["LC光纤连接器"]
 a| 
用于夹层卡的 16 Gb FC 或 25 GbE 电缆（取决于订单）
...
. 将缆线管理设备连接到控制器背面(如图所示)。
+
image::../media/drw_c400_cable_tray_IEOPS-1208.svg[DRW C400电缆托架IEOPS 1208]
...
. 按照图示完成控制器和交换机之间的布线：
+
image::../media/drw_c400_TNSC-networking-cabling_IEOPS-1189.svg[DRW C400 TNSC网络布线IEOPS 1189.]
...
. 按照图示完成控制器和交换机之间的布线：
+
image::../media/drw_c400_switched_network_cabling_IEOPS-1190.svg[DRW C400交换网络IEOPS 1190的布线]
...
. 使用下图将控制器连接到单个驱动器架。
+
image::../media/drw_c400_one_ns224_shelf_IEOPS-1191.svg[DRW C400单个ns224磁盘架IEOPS 1191]
...
. 使用下图将控制器连接到两个驱动器架。
+
image::../media/drw_c400_two_ns224_shelves_IEOPS-1192.svg[DRW C400两个ns224磁盘架IEOPS 1192]
