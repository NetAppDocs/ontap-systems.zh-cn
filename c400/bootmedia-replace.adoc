...
summary: 要更换启动介质，您必须卸下受损的控制器模块，安装替代启动介质并将启动映像传输到 USB 闪存驱动器。 
---
= 使用手动启动恢复过程更换 AFF C400 存储系统中的启动介质
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
通过卸下受损的控制器模块、安装替换启动介质并使用 USB 闪存驱动器传输启动映像，更换 AFF C400 存储系统中的启动介质。
