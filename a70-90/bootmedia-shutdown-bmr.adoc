...
summary: 关闭 AFF A70 或 AFF A90 存储系统中的控制器，以防止数据丢失，并确保更换启动介质时的系统稳定性。 
---
= 在自动启动恢复过程中关闭 AFF A70 或 AFF A90 系统中的控制器
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
关闭 AFF A70 或 AFF A90 存储系统中的控制器，以防止数据丢失，并在自动启动介质恢复过程中保持系统稳定性。
