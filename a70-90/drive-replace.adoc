...
summary: 如果驱动器出现故障或需要升级、请更换AFF A70或AFF A90系统中的驱动器。此过程包括确定故障驱动器、安全地将其卸下以及安装新驱动器、以确保持续访问数据和提高系统性能。 
---
...
[role="lead"]
如果驱动器出现故障或需要升级、请更换AFF A70或AFF A90系统中的驱动器。此过程包括确定故障驱动器、安全地将其卸下以及安装新驱动器、以确保持续访问数据和提高系统性能。
