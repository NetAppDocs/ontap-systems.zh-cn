...
summary: 如果需要更换机箱、请关闭AFF A70或AFF A90存储系统中的控制器。在执行维护或组件更换之前、请务必安全地关闭控制器、以防止数据丢失并确保系统稳定性。 
---
...
[role="lead"]
如果需要更换机箱、请关闭AFF A70或AFF A90存储系统中的控制器。在执行维护或组件更换之前、请务必安全地关闭控制器、以防止数据丢失并确保系统稳定性。
