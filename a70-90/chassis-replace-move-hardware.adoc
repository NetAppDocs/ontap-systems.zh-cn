...
summary: 当硬件故障需要时，请更换 AFF A70 或 AFF A90 系统中的机箱。更换过程包括卸下控制器和电源装置、卸下驱动器、安装更换机箱和重新安装机箱组件。 
---
= 更换 AFF A70 或 AFF A90 系统中的底盘
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
当您的AFF A70或AFF A90系统出现硬件故障需要更换机箱时，请更换机箱。更换过程包括移除控制器和电源装置 (PSU)、移除驱动器、安装更换机箱以及重新安装机箱组件。
