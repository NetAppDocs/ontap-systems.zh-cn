...
summary: 如果检测到可更正或不可更正的错误过多、请更换AFF A70或AFF A90系统中的DIMM。这些问题通常由单个DIMM故障引起、可能会阻止存储系统启动ONTAP。 
---
...
[role="lead"]
如果检测到可更正或不可更正的错误过多、请更换AFF A70或AFF A90系统中的DIMM。这些问题通常由单个DIMM故障引起、可能会阻止存储系统启动ONTAP。
