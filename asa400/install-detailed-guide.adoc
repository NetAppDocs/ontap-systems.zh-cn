...
summary: 这些详细步骤将引导您完成 ASA A400 系统的安装，包括安装准备、安装硬件、布线控制器和完成设置。 
---
= 安装 ASA A400 存储系统，包括详细步骤
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
这些详细步骤将引导您完成 ASA A400 系统的安装，包括安装准备、安装硬件、布线控制器和完成设置。
...
+
image::../media/drw_A400_TNSC-network-cabling.png[双节点无交换机集群]
...
+
image::../media/drw_a400_switched_network_cabling.png[交换集群网络布线]
...
+
image::../media/drw_a400_two_ns224_shelves.png[使用缆线将NS224磁盘架连接到控制器]
...
+
image::../media/drw_a400_three_ds224c_shelves.png[使用缆线将三个NS224磁盘架连接到控制器]
