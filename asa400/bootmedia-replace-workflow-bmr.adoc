...
summary: 通过查看更换要求、关闭控制器、更换启动介质、恢复启动介质上的映像以及验证系统功能，开始更换ASA A400存储系统中的启动介质。 
---
= 使用自动引导恢复过程的 ASA A400 系统的引导介质更换工作流程
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
启动映像的自动恢复涉及系统自动识别并选择适当的启动菜单选项。它使用合作伙伴节点上的启动映像在ASA A400系统中的替换启动介质上重新安装ONTAP 。
