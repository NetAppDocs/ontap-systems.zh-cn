...
summary: 您需要更换控制器模块中的实时时钟 RTC 电池，以便依赖于准确时间同步的系统服务和应用程序继续运行。 
---
= 更换 ASA A400 系统中的实时时钟电池
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image::../media/drw_c400_remove_controller_IEOPS-1216.svg[Remove controller module]
...
image::../media/drw_c400_rtc_batt_IEOPS-1239.svg[卸下RTC电池]
