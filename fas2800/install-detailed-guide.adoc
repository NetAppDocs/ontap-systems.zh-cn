...
+
image::../media/oie_cable_mini_sas_hd_to_mini_sas_hd.svg[迷你SAS到迷你SAS连接器]
...
+图像：../media/drw_2800_Shelf-to-Shelbing_IEOPS-8.svg[磁盘架到磁盘架布线]

+。使用缆线将控制器A连接到驱动器架。……控制器A端口0a到堆栈中第一个驱动器架上的IOM B端口1。……控制器A端口0b1到堆栈中最后一个驱动器架上的IOM A端口3。

+图像：../media/oie_cable_mini_sa_hd_to mini-sa_hd.svg[迷你SAS到迷你SAS连接器]

*迷你SAS HD到迷你SAS HD电缆*

+图像：../media/dwR-2800_controler1-to Shels_IEOPS-896.svg[控制器A到磁盘架连接]

+。将控制器B连接到驱动器架。……控制器B端口0a到堆栈中第一个驱动器架上的IOM A端口1。……控制器B端口0b1到堆栈中最后一个驱动器架上的IOM B端口3。

+图像：../media/oie_cable_mini_sa_hd_to mini-sa_hd.svg[迷你SAS到迷你SAS连接器]

*迷你SAS HD到迷你SAS HD电缆*

+图像：../media/dwR-2800_controler2-to Shels_IEOPS-897.svg[控制器B到磁盘架连接]
