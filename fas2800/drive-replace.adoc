...
summary: 当平台将警告消息记录到 FAS2820 系统控制台，并且操作员显示面板上的故障 LED 指示灯和故障驱动器亮起时，请热插拔 FAS2820 系统中的驱动器。您可以在不中断 I/O 的情况下更换驱动器，步骤略有不同，具体取决于驱动器是 SSD 还是 HDD。 
---
= 热插拔 FAS2820 系统中的驱动器
:allow-uri-read: 
:icons: font
...
[role="lead"]
当平台将警告消息记录到 FAS2820 系统控制台，并且操作员显示面板上的故障 LED 指示灯和故障驱动器亮起时，请热插拔 FAS2820 系统中的驱动器。您可以在不中断 I/O 的情况下更换驱动器，步骤略有不同，具体取决于驱动器是 SSD 还是 HDD。
