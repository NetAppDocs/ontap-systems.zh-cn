...
summary: 当平台向系统控制台记录指示驱动器发生故障的警告消息时，您必须更换 FAS2820 系统中的驱动器。操作员显示面板上的故障 LED 和故障驱动器上的故障 LED 均会亮起。 
---
= 更换 FAS2820 系统中的驱动器
:allow-uri-read: 
:icons: font
...
[role="lead"]
当平台向系统控制台记录指示驱动器发生故障的警告消息时，您必须更换 FAS2820 系统中的驱动器。操作员显示面板上的故障 LED 和故障驱动器上的故障 LED 均会亮起。
