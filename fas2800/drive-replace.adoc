...
summary: 当平台向系统控制台记录指示驱动器发生故障的警告消息时，您必须对 FAS2820 系统中的驱动器执行热插拔操作。操作员显示面板上的故障 LED 和故障驱动器上的故障 LED 都将点亮。 
---
= 热插拔 FAS2820 系统中的驱动器
:allow-uri-read: 
:icons: font
...
[role="lead"]
在 I/O 进行过程中，以无中断方式热插拔 FAS2820 系统中出现故障的驱动器，以恢复存储容量和性能。
