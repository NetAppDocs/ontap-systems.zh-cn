...
summary: 本节提供了有关安装ASA C800系统的详细分步说明。 
---
= 详细步骤—ASA C800
:allow-uri-read: 
:icons: font
...
[role="lead"]
本节提供了有关安装ASA C800系统的详细分步说明。



== 第 1 步：准备安装

要安装ASA C800系统、您需要创建一个帐户并注册该系统。You also need to inventory the appropriate number and type of cables for your system and collect specific network information.
...
+
image::../media/drw_asac800_weight_caution.png[DRW asac800重量注意事项]

. 连接缆线管理设备（如图所示）。
+
image::../media/drw_asac800_install_cable_mgmt.png[DRW asac800安装电缆管理]
...
image:../media/oie_legend_icon_3_lp.png[""]
 a| 
Cable the management ports to the management network switches    image:../media/drw_asac800_mgmt_cabling.png["此图显示了管理端口在系统背面的位置"]
...
image:../media/oie_legend_icon_1_mb.png[""]
 a| 
使用缆线将控制器 A 连接到磁盘架：    image:../media/drw_asac800_1shelf_cabling_a.png[""]
...
+
image::../media/drw_console_connect_asac800.png[DRW控制台连接asac800]

.. 将笔记本电脑或控制台连接到管理子网上的交换机。
+
image::../media/drw_client_mgmt_subnet_asac800.png[DRW客户端管理子网asac800]
