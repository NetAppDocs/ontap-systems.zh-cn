...
不适用
 a| 
image:../media/oie_cable_micro_usb.svg["微型USB电缆"]
 a| 
...
不适用
 a| 
image:../media/oie_cable_power.svg["宽=85个"]
 a| 
启动系统
...
image:../media/oie_cable_pull_tab_down.svg["宽度=200个"]
...
image:../media/oie_cable100_gbe_qsfp28.svg["宽度=50个"]
...
100 GbE 缆线
 ...
 a| 
image:../media/oie_legend_icon_2_lo.svg["标注图标1"]
 a| 
...
100 GbE 缆线
 ...
 a| 
image:../media/oie_legend_icon_2_lo.svg["宽度=30个"]
 a| 
...
磁盘架ID LED
 ...
 a| 
image:../media/legend_icon_04.svg["宽度= 20"]
 a| 
磁盘架ID设置按钮
...
+
图像：[callout icon one] drw_a900_power-on_IEOPS-941.svg[wid=500P]
