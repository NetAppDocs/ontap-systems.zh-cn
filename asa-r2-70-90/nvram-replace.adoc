...
---
= 更换 ASA A70 或 ASA A90 系统中的 NVRAM
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
当非易失性存储器出现故障或需要升级时，请更换ASA A70 或ASA A90 系统中的NVRAM 。更换过程包括关闭受损的控制器、将控制器拉出几英寸以完全切断电源、更换NVRAM模块或NVRAM DIMM、重新分配磁盘，以及将故障部件返回给NetApp。
