...
summary: 在更换启动介质时、关闭ASA A70或ASA A90存储系统中的受损控制器、以防止数据丢失并确保系统稳定性。 
---
= 在自动启动恢复过程中关闭 ASA A70 或 ASA A90 系统中的控制器
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在更换启动介质时、关闭ASA A70或ASA A90存储系统中的受损控制器、以防止数据丢失并确保系统稳定性。
