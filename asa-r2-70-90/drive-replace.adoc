...
summary: 当驱动器出现故障或需要升级时，可热插拔 ASA A70 或 ASA A90 系统中的驱动器。此过程包括识别故障驱动器、安全地将其移除并安装新驱动器，以确保持续的数据访问和系统性能。 
---
= 在 ASA A70 或 ASA A90 系统中热插拔 SSD 驱动器
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
当驱动器出现故障或需要升级时，可热插拔 ASA A70 或 ASA A90 系统中的驱动器。此过程包括识别故障驱动器、安全地将其移除并安装新驱动器，以确保持续的数据访问和系统性能。
