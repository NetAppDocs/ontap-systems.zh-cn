...
summary: 通过查看更换要求、关闭控制器、更换启动介质、还原启动介质上的映像以及验证系统功能、开始更换ASA A70和ASA A90存储系统中的启动介质。 
---
= 使用自动引导恢复过程的 ASA A70 或 ASA A90 系统的引导介质更换工作流程
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
通过查看更换要求、关闭控制器、更换启动介质、还原启动介质上的映像以及验证系统功能、开始更换ASA A70和ASA A90存储系统中的启动介质。
