...
summary: 如果硬件故障需要更换ASA A70或ASA A90系统中的控制器。此过程包括删除受损控制器、将组件移至更换用的控制器、安装更换用的控制器以及重新启动系统。 
---
= 更换 ASA A70 或 ASA A90 系统中的控制器
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
如果硬件故障需要更换ASA A70或ASA A90系统中的控制器。此过程包括删除受损控制器、将组件移至更换用的控制器、安装更换用的控制器以及重新启动系统。
...
.下一步是什么？
更换故障的ASA A70 或ASA A90 控制器后，您需要：link:controller-replace-system-config-restore-and-verify.html["还原系统配置"] 。
