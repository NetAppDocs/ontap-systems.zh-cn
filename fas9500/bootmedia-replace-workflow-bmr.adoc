...
summary: 通过查看更换要求、关闭控制器、更换启动介质、恢复启动介质上的映像以及验证系统功能，开始更换FAS9500存储系统中的启动介质。 
---
= 使用自动启动恢复过程的 FAS9500 系统的启动介质更换工作流程
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
请使用自动启动恢复过程开始更换 FAS9500 存储系统中的启动介质。系统会自动识别并选择适当的启动菜单选项，然后使用配对节点上的启动映像在替换启动介质上重新安装 ONTAP。
