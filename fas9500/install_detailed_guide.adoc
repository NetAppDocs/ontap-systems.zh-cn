...
X66240A-5 （ 112-00600 ）， 5 米
 a| 
图像：./media/oie_cable_sfp_gbe_copper.png
 a| 
网络缆线
...
X66100-5 （ 112-00544 ）， 5 米
 a| 
图像：./media/oie_cable100_gbe_qsfp28.png
 a| 
以太网数据，集群网络
...
不适用
 a| 
图像：../media/oIE_cable_micro_USB.pngMicro USB连接器]
 a| 
...
| 步骤 | 在每个控制器上执行 
 ...
 a| 
图像：./media/icon_square_1_green.png
 a| 
使用缆线连接集群互连端口：
...
图像：./media/oie_cable100_gbe_qsfp28.png
 ...
 a| 
图像：./media/icon_square_2_yellow.png
 a| 
使用缆线连接控制器管理（扳手）端口。
...
图像：./media/oie_cable_rj45.png
 ...
 a| 
图像：./media/icon_square_3_orange.png
 a| 
使用缆线连接32 Gb FC网络交换机：
...
图像：./media/oie_cable100_gbe_qsfp28.png
 ...
 a| 
图像：./media/icon_square_4_red.png
 a| 
使用缆线连接25 GbE连接：
...
| 步骤 | 在每个控制器上执行 
 ...
 a| 
image::../media/icon_square_1_blue.png[图标方块1蓝色]
 a| 
...
迷你SAS缆线
 ...
 a| 
image::../media/icon_square_2_yellow.png[图标方形2黄色]
 a| 
