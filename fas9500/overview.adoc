...
[role="lead"]
查看单个高可用性 (HA) 对中 FAS9500 存储系统的选定规格，并访问 https://hwu.netapp.com["NetApp Hardware Universe"^] (HWU) 以获取 FAS9500 规格的完整列表。
...
* 工作温度/海拔/湿度：10°C 至 35°C（50°F 至 95°F），海拔最高可达 3048 米（10000 英尺）；相对湿度 8% 至 90%，无冷凝
* 非工作温度/湿度：-40°C 至 70°C（-40°F 至 158°F），海拔最高 12192 米（40000 英尺），相对湿度 10% 至 95%，无冷凝，原包装
* 声学噪声：标称声功率 (LwAd)：7.4；声压 (LpAm)（旁观者位置）：65.0 分贝
