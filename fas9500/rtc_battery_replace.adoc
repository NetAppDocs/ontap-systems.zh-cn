...
summary: 更换控制器模块中的实时时钟电池。 
---
= 更换 FAS9500 系统中的实时时钟电池
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image::../media/drw_9500_remove_RTC_battery.svg[Replace the RTC battery]
...
更换 RTC 电池后，必须重新安装控制器模块。如果 RTC 电池已从控制器模块中取出超过 10 分钟，则可能需要重置时间和日期。
