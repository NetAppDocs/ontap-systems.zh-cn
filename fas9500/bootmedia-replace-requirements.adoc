...
summary: 在更换 FAS9500 系统中的启动介质之前，请验证您是否满足成功更换所需的要求。这包括确保您有一个具有适当存储容量的 USB 闪存驱动器，并验证您的更换启动设备是否正确。 
---
= 查看 FAS9500 系统中手动启动介质恢复的要求
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在更换 FAS9500 系统中的启动介质之前，请验证您是否满足成功更换所需的要求。这包括确保您有一个具有适当存储容量的 USB 闪存驱动器，并验证您的更换启动设备是否正确。
