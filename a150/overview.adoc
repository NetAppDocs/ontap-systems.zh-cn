...
[role="lead"]
查看 AFF A150 存储系统的部分规格，这些规格反映了单个高可用性对。请访问 https://hwu.netapp.com["NetApp Hardware Universe"^]（HWU）以获取 AFF A150 规格的完整列表。
...
* 工作温度/海拔/湿度：5°C 至 45°C（41°F 至 113°F），海拔最高可达 3048 米（10000 英尺）；相对湿度 8% 至 90%，无冷凝
* 非工作温度/湿度：-40°C 至 70°C（-40°F 至 158°F），海拔最高 12192 米（40000 英尺），相对湿度 10% 至 95%，无冷凝，原包装
* 声学噪声：标称声功率 (LwAd)：6.9；声压 (LpAm)（旁观者位置）：51.0 分贝
