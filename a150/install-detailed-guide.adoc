...
[role="lead"]
从准备现场到启动 ONTAP 集群，请按照这些详细的分步说明安装 AFF A150 存储系统。

如果您使用的是MetroCluster 配置、请使用 https://docs.netapp.com/us-en/ontap-metrocluster/index.html["MetroCluster 文档"^]。

*警告：* 如果您正在安装 ONTAP 9.13.1P8 - 9.13.1P11、ONTAP 9.14.1P1 - 9.14.1P7 或 ONTAP 9.15.1 - 9.15.1P2，并且您的系统包含 10 个或更多内部固态驱动器，请采取其他步骤来准备系统以进行安装。请参阅问题  https://mysupport.netapp.com/site/bugs-online/product/ONTAP/JiraNgage/CONTAP-285173["COOTP-285173 - ADP不会在具有10个或更多内部驱动器的AFF A150上保留备用根分区"^]。
...
** 存储系统的机架空间
** 2 号十字螺丝刀
** 用于将系统连接到网络交换机以及配有 Web 浏览器的笔记本电脑或控制台的其他网络电缆
** 具有 RJ-45 连接并可访问网络浏览器的笔记本电脑或控制台
...
--
以太网网络配置:: 使用 Cat 6 RJ45 电缆将 e0c 至 e0f 端口连接到主机网络，如下图所示。
+
--
