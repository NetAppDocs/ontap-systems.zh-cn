...
[role="lead"]
当存储系统遇到过多的可更正 (CECC) 或不可更正的内存错误时，请更换 AFF A150 系统中的 DIMM。此类错误可能会阻止存储系统启动 ONTAP。
...
. 返回到 <<第 3 步：更换 DIMM>> of this procedure to recheck the NVMEM LED.
. 找到控制器模块上的 DIMM 。
