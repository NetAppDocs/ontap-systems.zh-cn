...
summary: 当存储系统遇到过多的可纠正 ECC 错误或不可纠正 ECC 错误时，请更换 FAS2700 系统中的 DIMM，这些错误通常是由单个 DIMM 故障引起的。 
---
= 更换 FAS2700 系统中的 DIMM 以修复内存错误
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
当存储系统遇到过多的可纠正 ECC 错误或不可纠正 ECC 错误时，请更换 FAS2700 系统中的 DIMM，这些错误通常是由单个 DIMM 故障引起的。
