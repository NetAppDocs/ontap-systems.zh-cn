...
summary: 准备更换ASA A1K 系统中受损的机箱，方法是识别受损的机箱、验证更换组件并标记电缆和控制器模块。 
---
= 准备更换机箱 - ASA A1K
:allow-uri-read: 
:icons: font
...
[role="lead"]
通过识别受损机箱、验证更换组件以及标记电缆和控制器模块，准备更换ASA A1K 系统中受损的机箱。
...
.下一步是什么？
准备好更换ASA A1K 机箱硬件后，您需要link:chassis-replace-shutdown.html["关闭控制器"]。
