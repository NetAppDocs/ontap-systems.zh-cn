...
summary: 将I/O模块添加到ASA A1K系统、以增强网络连接并扩展系统处理数据流量的能力。 
---
= 向 ASA A1K 系统添加 I/O 模块以增强网络连接
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
将I/O模块添加到ASA A1K系统、以增强网络连接并扩展系统处理数据流量的能力。

当有空插槽可用或所有插槽均已完全填充时、您可以将I/O模块添加到ASA A1K存储系统。.关于此任务
