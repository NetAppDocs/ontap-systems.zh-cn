...
summary: 当风扇出现故障或无法有效运行时，请更换 ASA C30 存储系统中的风扇模块，因为这会影响系统冷却和整体性能。更换过程包括关闭控制器、卸下控制器、更换风扇、重新安装控制器以及将故障部件退回NetApp。 
---
= 更换风扇模块- ASA C30
:allow-uri-read: 
:icons: font
...
[role="lead"]
当风扇出现故障或无法有效运行时，请更换 ASA C30 存储系统中的风扇模块，因为这会影响系统冷却和整体性能。更换过程包括关闭控制器、卸下控制器、更换风扇、重新安装控制器以及将故障部件退回NetApp。
