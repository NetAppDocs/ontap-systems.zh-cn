...
summary: 当驱动器出现故障或需要升级时，请更换 ASA C30 存储系统中的驱动器。更换过程包括确定故障驱动器、安全地将其卸下以及安装新驱动器、以确保持续访问数据和提高系统性能。 
---
= 在 ASA C30 系统中热插拔驱动器
:allow-uri-read: 
:icons: font
...
[role="lead"]
当驱动器出现故障或需要升级时，请更换 ASA C30 存储系统中的驱动器。更换过程包括确定故障驱动器、安全地将其卸下以及安装新驱动器、以确保持续访问数据和提高系统性能。
