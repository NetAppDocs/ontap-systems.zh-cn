...
summary: 当驱动器出现故障或需要升级时，在 ASA C30 存储系统中热插拔驱动器。更换过程包括识别故障驱动器、安全地将其移除并安装新驱动器，以确保持续的数据访问和系统性能。 
---
= 在 ASA C30 系统中热插拔驱动器
:allow-uri-read: 
:icons: font
...
[role="lead"]
当驱动器出现故障或需要升级时，在 ASA C30 存储系统中热插拔驱动器。更换过程包括识别故障驱动器、安全地将其移除并安装新驱动器，以确保持续的数据访问和系统性能。
