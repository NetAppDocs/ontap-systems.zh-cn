...
summary: AFF C30 和 AFF C60 存储系统在单个高可用性对中的关键规格 
---
= AFF C30 和 AFF C60 的关键规格
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
以下是 AFF C30 和 AFF C60 存储系统在单个高可用性对中的选定规格。请访问 https://hwu.netapp.com["NetApp Hardware Universe"^]以获取这些存储系统的完整规格。
