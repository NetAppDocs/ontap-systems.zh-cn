...
summary: 当驱动器出现故障或需要升级时，请更换AFF C30 或AFF C60 存储系统中的驱动器。更换过程包括识别故障驱动器、安全移除它以及安装新驱动器以确保持续的数据访问和系统性能。 
---
= 更换 AFF C30 或 AFF C60 存储系统中的驱动器
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
当驱动器出现故障或需要升级时，请更换AFF C30 或AFF C60 存储系统中的驱动器。更换过程包括识别故障驱动器、安全移除它以及安装新驱动器以确保持续的数据访问和系统性能。
