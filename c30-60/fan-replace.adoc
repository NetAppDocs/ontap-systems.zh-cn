...
summary: 当风扇出现故障或运行效率低下时、请更换AFF C30或AFF C60系统中的风扇模块、因为这会影响系统散热和整体性能。更换过程包括关闭控制器、卸下控制器、更换风扇、重新安装控制器以及将故障部件退回NetApp。 
---
...
[role="lead"]
当风扇出现故障或运行效率低下时、请更换AFF C30或AFF C60系统中的风扇模块、因为这会影响系统散热和整体性能。更换过程包括关闭控制器、卸下控制器、更换风扇、重新安装控制器以及将故障部件退回NetApp。
