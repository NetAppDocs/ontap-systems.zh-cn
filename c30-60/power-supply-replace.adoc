...
summary: 当 AFF C30 或 AFF C60 存储系统中的交流或直流电源装置发生故障或出现问题时，请进行更换，以确保系统持续获得稳定运行所需的电源。更换过程包括从电源断开故障电源装置，拔下电源线，更换故障电源装置，然后将其重新连接到电源。 
---
= 热插拔 AFF C30 或 AFF C60 存储系统中的电源单元
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
当AFF C30 或AFF C60 存储系统中的交流或直流电源装置 (PSU) 发生故障或故障时，请更换该装置，以确保系统继续接收稳定运行所需的电力。更换过程包括将故障的 PSU 与电源断开、拔下电源线、更换故障的 PSU，然后将其重新连接到电源。
