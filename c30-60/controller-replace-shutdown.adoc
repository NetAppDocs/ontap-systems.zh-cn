...
summary: 关闭AFF C30或AFF C60存储系统中的受损控制器、以防止数据丢失、并在更换控制器时确保系统稳定性。 
---
= 在更换之前，关闭 AFF C30 或 AFF C60 存储系统中受损的控制器
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
关闭AFF C30或AFF C60存储系统中的受损控制器、以防止数据丢失、并在更换控制器时确保系统稳定性。
