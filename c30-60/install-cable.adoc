...
---
= 连接 AFF C30 和 AFF C60 硬件以实现网络和存储连接
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image::../media/drw_isi_a30-50_switchless_2p_100gbe_2card_cabling_ieops-2011.svg[使用两个 100GbE IO 模块的 c30 和 c60 无交换机集群布线图]
...
+
image::../media/drw_isi_a30-50_switchless_2p_100gbe_1card_cabling_ieops-1925.svg[使用一个 100GbE IO 模块的 c30 和 c60 无交换机集群布线图]
...
+
image::../media/drw_isi_a30-50_switched_2p_100gbe_2card_cabling_ieops-2013.svg[c30 和 c60 使用两个 100GbE IO 模块的交换集群布线图]
...
在每个控制器上，将端口 2a、2b、2c 和 2d 通过电缆连接到 FC 主机网络交换机。
