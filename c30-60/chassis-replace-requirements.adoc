...
summary: 在更换 AFF C30 或 AFF C60 存储系统的机箱之前，请确保满足成功更换的必要要求。这包括验证系统中的所有其他组件是否正常运行，以及您是否拥有正确的替换机箱和必要的工具。 
---
= 在更换 AFF C30 或 AFF C60 系统中的底盘之前，请查看要求
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在更换 AFF C30 或 AFF C60 存储系统的机箱之前，请确保满足成功更换的必要要求。这包括验证系统中的所有其他组件是否正常运行，以及您是否拥有正确的替换机箱和必要的工具。
