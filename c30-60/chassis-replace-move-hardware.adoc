...
summary: '当硬件故障需要更换AFF C30 或AFF C60 存储系统的机箱时。更换过程包括移除控制器和电源装置 (PSU)、移除驱动器、安装更换机箱以及重新安装机箱组件。' 
---
= 更换 AFF C30 或 AFF C60 存储系统中的机箱
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
当硬件故障需要更换AFF C30 或AFF C60 存储系统的机箱时。更换过程包括移除控制器、移除驱动器、安装更换机箱以及重新安装机箱组件。
