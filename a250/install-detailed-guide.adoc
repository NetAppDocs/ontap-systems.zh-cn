...
+
link:https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=beec3966-0a01-473c-a5de-ac68017fbf29["为双节点无交换机集群布线"^]
...
. 使用动画或分步说明完成控制器与交换机之间的布线：
+
link:https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=bf6759dc-4cbf-488e-982e-ac68017fbef8["为交换集群布线"^]
...
+
link:https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=3f92e625-a19c-4d10-9028-ac68017fbf57["使用缆线将控制器连接到一个 NS224"^]
