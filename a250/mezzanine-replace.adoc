...
link:https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=d8e7d4d9-8d28-4be1-809b-ac5b01643676["更换夹层卡"^]
...
.. 使用 1 号磁性螺丝起子，从控制器模块表面上拆下螺钉，并将其安全地放在磁铁上。
.. 使用 1 号磁性螺丝起子松开受损夹层卡上的螺钉。
.. 将受损夹层卡直接从插槽中轻轻提起并放在一旁
.. 从防静电运输袋中取出更换用的夹层卡，并将其与控制器模块的内表面对齐。
.. 将更换用的夹层卡轻轻对齐到位。
.. 使用 1 号磁性螺丝起子插入并拧紧控制器模块正面和夹层卡上的螺钉。
+
...
. 如果您的系统没有新的夹层卡，请安装一个。
+
.. 使用 1 号磁性螺钉驱动器，从控制器模块表面以及覆盖夹层卡插槽的面板上卸下螺钉，并将其安全地放在磁铁上。
