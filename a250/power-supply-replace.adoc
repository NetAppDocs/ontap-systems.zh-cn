...
summary: 通过断开目标 PSU 与电源的连接、拔下电源线、移除旧 PSU、安装更换的 PSU，然后将其重新连接到电源，来更换 AFF A250 系统中的电源。 
---
= 热插拔 AFF A250 系统中的电源单元
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
当 AFF A250 系统中的电源出现故障或发生问题时，请更换电源。电源是冗余且可热插拔的，因此您无需关闭控制器即可执行此更换。
