...
ONTAP硬件系统文档现在包括以下规范：link:https://hwu.netapp.com["Hardware Universe"] 。例如，link:https://docs.netapp.com/us-en/ontap-systems_hotfix-main/a1k/overview.html["AFF A1K的主要规格"] 。
