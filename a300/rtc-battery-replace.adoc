...
summary: 更换 AFF A300 控制器模块中的实时时钟电池，以确保依赖于准确时间同步的服务和应用程序继续运行。 
---
= 更换 AFF A300 系统中的实时时钟电池
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
更换 AFF A300 系统中的实时时钟 (RTC) 电池，以确保依赖于准确时间同步的服务和应用程序继续运行。
...
. 找到 RTC 电池。
+
image::../media/drw_rxl_rtc_battery.png[卸下或更换RTC电池]
