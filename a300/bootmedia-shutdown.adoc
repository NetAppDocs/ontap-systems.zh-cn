...
summary: 您可以根据存储系统硬件配置的不同，使用不同的程序来关闭或接管故障控制器。AFF A300系统仅支持手动启动介质恢复程序。 
---
= 在手动启动恢复过程中关闭 AFF A300 系统中受损的控制器
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
使用适合您配置的相应程序关闭或接管故障控制器。AFF A300系统仅支持手动启动介质恢复程序。不支持自动启动介质恢复。
