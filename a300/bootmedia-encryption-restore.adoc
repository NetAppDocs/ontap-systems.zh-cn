...
summary: 在更换的启动介质上恢复加密。完成特定于启用了板载密钥管理器、NetApp 存储加密或 NetApp 卷加密的系统的步骤。AFF A300 系统仅支持手动启动介质恢复过程。 
---
= 在 AFF A300 系统中的启动介质上恢复加密
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
恢复替换启动介质上的加密。AFF A300系统仅支持手动启动介质恢复程序。不支持自动启动介质恢复。
