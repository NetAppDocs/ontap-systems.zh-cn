...
summary: 完成 NVE 或 NSE 任务后，需要完成受损节点的关闭。AFF A320系统仅支持手动启动介质恢复程序。不支持自动启动介质恢复。 
---
= 在手动启动恢复过程中关闭 AFF A320 系统中受损的控制器
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
完成 NVE 或 NSE 任务后，需要完成受损节点的关闭。使用适合您配置的相应程序关闭或接管故障控制器。AFF A320系统仅支持手动启动介质恢复程序。不支持自动启动介质恢复。
