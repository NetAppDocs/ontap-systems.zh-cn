...
| 交换机 | Description | 可从一开始使用 
 ...
 a| 
https://["36 端口 100 GbE Cisco 交换机（ X190200 ）"]
 a| 
...
ONTAP 9.9.1
 ...
 a| 
https://["36 端口 100 GbE Cisco 交换机（ X190200 和 X190210 ）"]
 a| 
...
ONTAP 9.8
 ...
 a| 
https://["Broadcom BES-53248 交换机（ X190005 和 X190005R ）"]
 a| 
...
ONTAP 9.8
 ...
 a| 
https://["36 端口 100 GbE Cisco 交换机（ X190200 ）"] https://["32 端口 100 GbE Cisco 交换机（ X190100 和 X190100R ）"]
 a| 
...
有关 MetroCluster 专用的其他过程，请参见 https://["选择升级或刷新方法"]。
...
9.8
 a| 
https://["使用 `ssystem controller replace` 命令升级运行 ONTAP 9.8 的控制器硬件"]
 a| 
是的。
 a| 
是（ FC ）
...
9.8
 a| 
https://["使用聚合重新定位手动升级运行 ONTAP 9.8 或更高版本的控制器硬件"]
 a| 
是的。
 a| 
是（ FC ）
...
9.7 到 9.5
 a| 
https://["使用 `ssystem controller replace` 命令将运行 ONTAP 9.5 的控制器硬件升级到 ONTAP 9.7"]
 a| 
是的。
 a| 
是（ FC ）
...
9.7 及更早版本
 a| 
https://["将具有聚合重新定位的控制器升级到手动升级运行 ONTAP 9.7 及更早版本的控制器硬件"]
 a| 
是的。
 a| 
是（ FC ）
