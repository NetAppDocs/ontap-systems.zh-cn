...
summary: 如果模块出现故障并且存储系统满足所有 ONTAP 版本要求，则可以在 AFF A1K 存储系统中热插拔以太网 I/O 模块。 
---
= 在 AFX 1K 存储系统中热插拔 I/O 模块
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
如果模块出现故障并且存储系统满足所有 ONTAP 版本要求，则可以在 AFF A1K 存储系统中热插拔以太网 I/O 模块。
