...
summary: 在硬件故障需要时更换 AFX 1K 存储系统的机箱。更换过程包括从机箱前部卸下控制器，卸下电源单元、NVRAM12、I/O 模块和空白以及系统管理模块，然后安装更换机箱，并重新安装机箱组件。 
---
= 更换 AFX 1K 存储系统中的机箱
:allow-uri-read: 
:icons: font
...
.下一步是什么？
更换损坏的 AFX 1K 机箱并重新安装其组件后，请完成link:chassis-replace-complete-system-restore-rma.html["底盘更换"]。
