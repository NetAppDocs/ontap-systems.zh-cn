...
summary: 当模块出现故障或需要升级以支持更高性能或附加功能时，请更换 AFX 1K 存储系统中的 I/O 模块。更换过程包括关闭控制器、更换故障的 I/O 模块、重新启动控制器，以及将故障部件退回NetApp。 
---
= 更换 AFX 1K 存储系统中的 I/O 模块
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
当模块出现故障时，更换 AFX 1K 存储系统中的 I/O 模块。更换过程包括关闭控制器、更换故障的 I/O 模块、重新启动控制器，以及将故障部件退回NetApp。
