...
summary: 当电池开始失去电量或出现故障时，请更换 AFX 1K 存储系统中的 NV 电池，因为它负责在断电期间保存关键系统数据。更换过程包括关闭受损的控制器、移除控制器模块、更换 NV 电池、重新安装控制器模块以及将故障部件退回给NetApp。 
---
= 更换 AFX 1K 存储系统中的 NV 电池
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
当电池开始失去电量或出现故障时，请更换 AFX 1K 存储系统中的 NV 电池，因为它负责在断电期间保存关键系统数据。更换过程包括关闭受损的控制器、移除控制器模块、更换 NV 电池、重新安装控制器模块以及将故障部件退回给NetApp。
