...
image::../media/drw_sys_cab_side_front_dimensions_ozeki.gif[系统机柜的正面背面和侧面图]
...
image::../media/drw_ozeki_sys_cab_bottom_top_dimensions_ieops-1803.svg[系统机柜的顶部和底部视图]
