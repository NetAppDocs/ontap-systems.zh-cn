...
summary: 您可以使用布线工作表定义控制器 SAS 端口对，可用于将控制器连接到磁盘架堆栈以实现多路径连接。 
---
= DS212C、DS224C 或 DS460C 多路径连接的布线工作表
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
您可以使用布线工作表定义控制器 SAS 端口对，以便将控制器连接到磁盘架堆栈，从而在 HA 对或单控制器配置中实现多路径连接。您还可以使用已完成的工作表为配置布线多路径连接。
