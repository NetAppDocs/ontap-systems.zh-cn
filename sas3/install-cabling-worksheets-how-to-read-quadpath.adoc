...
summary: 使用此示例指导您阅读完整的工作表并将其应用于磁盘架的电缆堆栈，以实现四路径连接。 
---
= 阅读工作表，了解 DS212C、DS224C 或 DS460C 四路径连接的控制器到堆栈的线缆连接
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
您可以使用此示例指导您如何阅读完整的工作表并将其应用于具有 IOM12、IOM12B 或 IOM12C 模块的磁盘架电缆堆栈，以实现四路径连接。
