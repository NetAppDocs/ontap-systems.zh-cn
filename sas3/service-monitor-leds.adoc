...
---
= 监控 DS212C、DS224C 或 DS460C 磁盘架 LED
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
稳定琥珀色
 a| 
一个或多个FRU的功能出错：磁盘架、磁盘驱动器、IOM12、IOM12B或IOM12C模块或电源。
...
操作员显示面板上的位置 LED 以及两个 IOM12、IOM12B 或 IOM12C 模块在激活此 LED 功能时都会亮起。位置 LED 在 30 分钟后自动关闭。
...
== IOM12、IOM12B 或 IOM12C 模块 LED

IOM12、IOM12B 或 IOM12C 模块上的 LED 指示灯指示模块是否正常工作，是否已为 I/O 流量做好准备，以及硬件是否存在任何问题。

下表描述了与模块功能以及模块上每个 SAS 端口功能相关的 IOM12、IOM12B 或 IOM12C 模块 LED。

IOM12、IOM12B 或 IOM12C 模块用于 DS460C、DS224C 和 DS212C 磁盘架。
...
稳定琥珀色
 a| 
IOM12、IOM12B 或 IOM12C 模块功能：IOM12、IOM12B 或 IOM12C 模块的功能出现错误。
...
呈蓝色稳定亮起
 a| 
系统管理员激活了此 LED 功能，以帮助物理定位出现故障的 IOM12、IOM12B 或 IOM12C 模块的磁盘架。
...
image::../media/drw_iom12.gif[IOM12模块,828px,147px]

IOM12B模块通过蓝色条带和"IOM12B"标签来区分：

image::../media/iom12b.png[IOM12B模块,828px,147px]

IOM12C 模块由蓝色和灰色条纹以及"IOM12C"标签区分：

image::../media/drw_iom12c_ieops-2175.svg[IOM12C 模块,828px,147px]
