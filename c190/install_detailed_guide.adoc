...
summary: 本指南详细介绍了安装 AFF C190 系统的分步说明。 
---
= 详细指南— AFF C190
:icons: font
:imagesdir: ../media/
...
.. 登录到现有帐户或创建帐户。
+
link:https://mysupport.netapp.com/eservice/public/now.do["NetApp 支持注册"]
...
.. 使用中收集的数据配置系统 link:https://library.netapp.com/ecm/ecm_download_file/ECMLP2862613["《 NetApp ONTAP 配置指南》"]。
