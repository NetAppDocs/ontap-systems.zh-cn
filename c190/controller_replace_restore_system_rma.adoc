...
summary: '要将系统恢复到完全运行状态，您必须还原 NetApp 存储加密配置（如果需要），并为新控制器安装许可证，然后按照套件随附的 RMA 说明将故障部件退回 NetApp 。请通过联系技术支持 https://["NetApp 支持"]， 888-463-8277 （北美）， 00-800-44-638277 （欧洲）或 +800-800-80-800 （亚太地区）（如果您需要 RMA 编号或有关更换操作步骤的其他帮助）。' 
---
= 完成系统还原— AFF C190
:allow-uri-read: 
:icons: font
...
.步骤
. 如果需要新的许可证密钥，请在上获取替代许可证密钥 https://["NetApp 支持站点"] 在软件许可证下的我的支持部分中。
+
...
** 如果未启用 AutoSupport ，请调用 https://["NetApp 支持"] 注册序列号。
