...
summary: 关闭 FAS8300 或 FAS8700 存储系统中的控制器，以防止数据丢失并确保更换控制器时的系统稳定性。 
---
= 在更换之前，关闭 FAS8300 或 FAS8700 系统中受损的控制器
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
关闭 FAS8300 或 FAS8700 存储系统中的控制器，以防止数据丢失并确保更换控制器时的系统稳定性。
...
====
.下一步是什么？
关闭 FAS8300 和 FAS8700 控制器后，您需要link:controller-replace-move-hardware.html["更换控制器"]。
