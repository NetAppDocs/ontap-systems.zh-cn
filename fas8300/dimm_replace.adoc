...
[role="lead"]
更换系统 DIMM 需要通过相关的错误消息识别目标 DIMM ，使用风管上的 FRU 映射或主板上亮起的 LED 查找目标 DIMM ，然后更换 DIMM 。

您可以使用以下动画，绘图或写入步骤来更换系统 DIMM 。


NOTE: 此动画显示了没有 DIMM 的插槽中的空插槽。这些空插槽中填有空格。

https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=175c6597-449e-4dc8-8c02-aad9012f08b5["更换系统 DIMM"]
