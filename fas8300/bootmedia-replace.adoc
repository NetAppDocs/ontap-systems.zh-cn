...
---
= 使用手动启动恢复过程更换 FAS8300 或 FAS8700 系统中的启动介质
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.开始之前
虽然引导介质的内容已加密，但最佳实践是在更换引导介质之前擦除其内容。有关详细信息，请参见 NetApp 支持站点上适用于您系统的 https://mysupport.netapp.com/info/web/ECMP1132988.html["易失性声明"]。
