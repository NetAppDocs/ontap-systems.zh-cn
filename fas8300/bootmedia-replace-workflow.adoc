...
summary: 通过查看更换要求、检查加密状态、关闭控制器、更换启动介质、启动恢复映像、恢复加密以及验证系统功能，开始替换 FAS8300 或 FAS8700 存储系统中的启动介质。 
---
= 使用手动启动恢复过程的 FAS8300 或 FAS8700 系统的启动介质更换工作流程
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
通过查看更换要求、检查加密状态、关闭控制器、更换启动介质、启动恢复映像、恢复加密以及验证系统功能，开始替换 FAS8300 或 FAS8700 存储系统中的启动介质。
