...
summary: 关闭 FAS8300 或 FAS8700 存储系统中的控制器，以防止数据丢失并确保更换启动介质时的系统稳定性。 
---
= 在自动引导恢复过程中关闭 FAS8300 或 FAS8700 系统中的控制器
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
关闭 FAS8300 或 FAS8700 存储系统中的控制器，以防止数据丢失并确保更换启动介质时的系统稳定性。
