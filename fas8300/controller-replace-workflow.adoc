...
summary: 通过关闭受损控制器、移除并更换控制器、恢复系统配置以及将存储资源的控制权返回给更换的控制器，来更换 FAS8300 或 FAS8700 存储系统中的控制器。 
---
= 控制器更换工作流程 - FAS8300 和 FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
通过关闭受损控制器、移除并更换控制器、恢复系统配置以及将存储资源的控制权返回给更换的控制器，来更换 FAS8300 或 FAS8700 存储系统中的控制器。
