...
sidebar: sidebar 
keywords:  
summary: 要启动并运行AFF、ASA和FAS系统、您需要在ONTAP中安装硬件组件、配置交换机和配置存储。 
---
...
[role="lead"]
要启动并运行AFF、ASA和FAS系统、您需要在ONTAP中安装硬件组件、配置交换机和配置存储。
...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-1.png["一个"] 安装控制器
[role="quick-margin-para"]
在机架或机柜中安装AFF、ASA和FAS控制器。访问适用于您的平台型号的安装和设置说明。
...
[role="quick-margin-para"]
配置交换机并安装所需软件后、请访问适用于您的平台型号的安装和设置说明以完成系统设置。
