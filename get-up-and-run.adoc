...
* link:https://docs.netapp.com/us-en/ontap-systems-switches/cluster/index.html["集群交换机"^]
* link:https://docs.netapp.com/us-en/ontap-systems-switches/storage/index.html["存储交换机"^]
...
[role="quick-margin-list"]
* link:aff-aseries/index.html["AFF A系列系统"]
* link:aff-cseries/index.html["AFF C系列系统"]
