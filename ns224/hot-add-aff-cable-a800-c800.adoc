...
summary: 将 NS224 磁盘架连接到 AFF A800 或 AFF C800 系统，以便每个磁盘架与 HA 对中的每个控制器有两个连接。 
---
= 将 NS224 架连接到您的 AFF A800 或 AFF C800 系统
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
将 NS224 磁盘架连接到 AFF A800 或 AFF C800 系统，以便每个磁盘架与 HA 对中的每个控制器有两个连接。
