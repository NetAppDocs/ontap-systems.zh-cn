...
summary: 将 NS224 机架连接到 ASA A70 或 ASA A90 系统，以便每个机架与 HA 对中的每个控制器有两个连接。 
---
= 将 NS224 架连接到您的 ASA A70 或 ASA A90 系统
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
将 NS224 机架连接到 ASA A70 或 ASA A90 系统，以便每个机架与 HA 对中的每个控制器有两个连接。
