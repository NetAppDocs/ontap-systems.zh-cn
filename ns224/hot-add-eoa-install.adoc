...
summary: 将 NS224 磁盘架安装在机柜或电信机架中，连接电源线，并为您的可用性终止系统设置磁盘架 ID。 
---
= 在可用性终止系统上安装 NS224 磁盘架
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
将 NS224 磁盘架安装在机柜或电信机架中，连接电源线，并为您的可用性终止系统设置磁盘架 ID。
...
.下一步是什么？
安装架子后，link:hot-add-eoa-cable-overview.html["为磁盘架布线"]。
