...
summary: 将 NS224 磁盘架安装在机柜或电信机架中，连接电源线，并为您的 ASA 系统设置磁盘架 ID。 
---
= 在您的 ASA 系统上安装 NS224 磁盘架
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
将 NS224 磁盘架安装在机柜或电信机架中，连接电源线，并为您的 ASA 系统设置磁盘架 ID。

.开始之前
* 确保您有一个一端拉直的回形针或窄尖圆珠笔。
+
...
.下一步是什么？
安装架子后，link:hot-add-asa-cable-overview.html["为磁盘架布线"]。
