...
summary: 将 NS224 机架连接到 ASA A30 或 ASA A50 系统，以便每个机架与 HA 对中的每个控制器有两个连接。 
---
= 将 NS224 架连接到您的 ASA A30 或 ASA A50 系统
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
将 NS224 机架连接到 ASA A30 或 ASA A50 系统，以便每个机架与 HA 对中的每个控制器有两个连接。

当需要额外存储（到内部机架）时，您最多可以将两个 NS224 机架热添加到 ASA A30 或 ASA A50 HA 对。
