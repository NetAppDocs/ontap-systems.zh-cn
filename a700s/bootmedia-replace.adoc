...
summary: 更换AFF A700s控制器模块上故障的启动介质。AFF A700s系统仅支持手动启动介质恢复程序。不支持自动启动介质恢复。 
---
= 更换 AFF A700s 系统中的启动介质
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
更换AFF A700s控制器模块上故障的启动介质。此程序包括从机箱中取出控制器模块，使用点亮的 LED 指示灯找到故障的启动介质，物理更换启动介质组件，并将系统恢复到正常运行状态。
...
+
image::../media/drw_a700s_boot_media_replace.png[更换启动介质]
