...
summary: 通过断开目标 PSU 与电源的连接、拔下电源线、移除旧 PSU、安装更换的 PSU，然后将其重新连接到电源，来更换 AFF A700s 系统中的电源。 
---
= 热插拔 AFF A700s 系统中的电源
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
通过断开、拆卸和更换故障设备，然后将其重新连接到电源，即可热插拔 AFF A700s 系统中的电源。
