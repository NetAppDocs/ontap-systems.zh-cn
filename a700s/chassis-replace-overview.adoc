...
[role="lead"]
在更换 AFF A700s 系统中的机箱之前，请查看成功更换的要求。机箱更换操作步骤会将控制器模块和 SSD 驱动器从受损机箱移至更换用机箱，此过程会造成中断。

系统中的所有其他组件必须正常运行；否则，您必须联系技术支持。

* 您可以将此操作步骤与系统支持的所有 ONTAP 版本结合使用。
* 编写此操作步骤时，假设您要将 SSD 和控制器模块移至新机箱，而更换的机箱是 NetApp 的新组件。
