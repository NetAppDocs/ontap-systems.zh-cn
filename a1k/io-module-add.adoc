...
. 如果您尚未接地，请正确接地。
. 从控制器的PSU上拔下电源设备(PSU)电缆。
+

NOTE: 如果存储系统具有直流PSU、请断开电源电缆块与PSU的连接。
...
. 如果安装了存储I/O模块，请按照中所述安装NS224磁盘架并为其布线 https://docs.netapp.com/us-en/ontap-systems/ns224/hot-add-shelf.html["Hot-add a shelf"^]。
