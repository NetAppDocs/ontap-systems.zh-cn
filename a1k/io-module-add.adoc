...
summary: 向AFF A1K系统添加I/O模块可增强网络连接并扩展系统处理数据流量的能力。 
---
= 在 AFF A1K 系统中添加 I/O 模块以增强网络连接
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
向AFF A1K系统添加I/O模块可增强网络连接并扩展系统处理数据流量的能力。

如果存在空插槽或所有插槽均已完全填充、则可以向AFF A1K存储系统添加I/O模块。
