...
summary: 在AFF A1K系统的替代启动介质上恢复加密、以确保持续提供数据保护。更换过程包括验证密钥可用性、重新应用加密设置以及确认对数据的安全访问。 
---
= 在手动启动恢复过程之后，在 AFF A1K 系统中恢复启动介质上的加密
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在AFF A1K系统的替代启动介质上恢复加密、以确保持续提供数据保护。更换过程包括验证密钥可用性、重新应用加密设置以及确认对数据的安全访问。
