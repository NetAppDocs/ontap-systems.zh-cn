...
summary: 当 AFF A1K 系统中的交流或直流电源单元出现故障或变得有缺陷时，请进行更换，以确保您的系统继续获得稳定运行所需的电源。更换过程包括从电源断开有故障的 PSU，拔下电源线，更换有故障的 PSU，然后将其重新连接到电源。 
---
= 热插拔 AFF A1K 系统中的电源单元
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
AFF A1K系统中的交流或直流电源设备(PSU)出现故障或出现故障时、请予以更换、以确保系统继续获得稳定运行所需的电源。更换过程包括断开故障PSU与电源的连接、拔下电源线、更换故障PSU、然后将其重新连接到电源。
