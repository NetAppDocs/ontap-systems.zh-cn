...
summary: 启动映像的自动恢复涉及系统自动识别并选择适当的启动菜单选项。它使用合作伙伴节点上的启动映像在AFF A1K系统中的替换启动介质上重新安装ONTAP 。 
---
...
[role="lead"]
启动映像的自动恢复涉及系统自动识别并选择适当的启动菜单选项。它使用合作伙伴节点上的启动映像在AFF A1K 存储系统中的替换启动介质上重新安装ONTAP 。
