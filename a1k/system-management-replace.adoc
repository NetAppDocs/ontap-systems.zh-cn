...
summary: 当 AFF A1K 系统中的系统管理模块出现故障或其固件损坏时，请更换该模块。更换过程包括关闭控制器、更换故障系统管理模块、重新启动控制器、更新许可证密钥以及将故障部件返回 NetApp。 
---
= 更换 AFF A1K 系统中的系统管理模块
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
当 AFF A1K 系统中的系统管理模块出现故障或其固件损坏时，请更换该模块。更换过程包括关闭控制器、更换故障系统管理模块、重新启动控制器、更新许可证密钥以及将故障部件返回 NetApp。
