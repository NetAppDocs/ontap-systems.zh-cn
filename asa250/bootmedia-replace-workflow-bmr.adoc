...
summary: 通过查看更换要求、关闭控制器、更换引导介质、在引导介质上恢复映像以及验证系统功能，开始更换 ASA A250 存储系统中的引导介质。 
---
= 使用自动引导恢复过程的 ASA A250 系统的引导介质更换工作流程
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
启动映像的自动恢复涉及系统自动识别和选择适当的启动菜单选项。它使用合作伙伴节点上的引导映像在 ASA A250 存储系统的替换引导介质上重新安装 ONTAP。
