...
[role="lead"]
After completing the NVE or NSE tasks, you need to complete the shutdown of the impaired node.After completing the NVE or NSE tasks, you need to complete the shutdown of the impaired node.
