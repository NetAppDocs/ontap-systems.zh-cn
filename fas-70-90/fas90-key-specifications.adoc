...
[role="lead"]
这些是单个高可用性对中 FAS90 存储系统的选定规格。请访问 NetApp Hardware Universe (HWU) 以获取此存储系统的完整规格。
...
* 最大原始容量：15.0000 PB
* 内存：1024.0000 GB
* 外形规格：2U 机箱，带一个高可用性控制器
* PCIe 扩展槽：18
* 最低ONTAP版本： ONTAP 9.15.1
...
* 重量：59.5磅，27.0公斤
* 高度：2U
* 宽度：19 英寸，符合 IEC 机架标准（17.7 英寸，44.9 厘米）
* 深度：30.0英寸（带线缆管理支架时为35.2英寸）
...
* 声学噪声：标称声功率 (LwAd)：8.5；声压 (LpAm)（旁观者位置）：67.7 分贝
