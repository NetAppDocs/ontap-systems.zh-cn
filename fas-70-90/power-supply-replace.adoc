...
summary: 当 FAS70 或 FAS90 系统中的交流或直流电源单元 PSU 发生故障或出现问题时，请进行更换，以确保系统持续获得稳定运行所需的电源。更换过程包括从电源断开有故障的 PSU，拔下电源线，更换有故障的 PSU，然后将其重新连接到电源。 
---
= 热插拔 FAS70 或 FAS90 系统中的电源单元
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
