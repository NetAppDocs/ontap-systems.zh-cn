...
image::../media/drw_ns224_lifting_weight_2_ieops-2960.svg[NS224 NSM100提升注意事项]

DS460C 磁盘架的重量最高可达 260.4 磅（118.1 千克）。要抬起存储磁盘架，最多可能需要五个人或一台液压升降机。将所有组件保留在存储磁盘架中（前部和后部），以防止磁盘架重量不平衡。
