...
summary: 开始更换FAS70或FAS90存储系统中的控制器、方法是关闭受损控制器、卸下并更换控制器、重新配置系统设置以及验证系统运行情况。 
---
= FAS70 和 FAS90 控制器更换工作流程
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
开始更换FAS70或FAS90存储系统中的控制器、方法是关闭受损控制器、卸下并更换控制器、还原系统配置、并将存储资源的控制权归还给替代控制器。
