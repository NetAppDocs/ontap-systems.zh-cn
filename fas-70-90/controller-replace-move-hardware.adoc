...
summary: 如果硬件故障需要更换FAS70或FAS90系统中的控制器。更换过程包括移除受损控制器、将组件移至更换控制器、安装更换控制器并重新启动它。 
---
= 更换 FAS70 或 FAS90 系统中的控制器
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
如果硬件故障需要更换FAS70或FAS90系统中的控制器。更换过程包括移除受损控制器、将组件移至更换控制器、安装更换控制器并重新启动它。
...
.下一步是什么？
在更换受损的FAS70或FAS90控制器后，您需要link:controller-replace-system-config-restore-and-verify.html["还原系统配置"]。
