...
summary: 将 I/O 模块添加到您的 FAS70 或 FAS90 系统中，以增强网络连接并扩展系统处理数据流量的能力。 
---
= 将 I/O 模块添加到 FAS70 或 FAS90 系统
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
将 I/O 模块添加到您的 FAS70 或 FAS90 系统中，以增强网络连接并扩展系统处理数据流量的能力。

当有空插槽可用或所有插槽都已完全填充时，您可以将 I/O 模块添加到 FAS70 或 FAS90 存储系统中。
