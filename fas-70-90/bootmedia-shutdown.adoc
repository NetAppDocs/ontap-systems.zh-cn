...
summary: 需要更换启动介质时、关闭FAS70或FAS90存储系统中的控制器。在执行维护或组件更换之前、请务必安全地关闭控制器、以防止数据丢失并确保系统稳定性。 
---
= 关闭控制器以更换启动介质- FAS70和FAS90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
需要更换启动介质时、关闭FAS70或FAS90存储系统中的控制器。在执行维护或组件更换之前、请务必安全地关闭控制器、以防止数据丢失并确保系统稳定性。
