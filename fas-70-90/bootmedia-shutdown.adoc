...
summary: 关闭 FAS70 或 FAS90 存储系统中受损的控制器，以防止数据丢失并在手动启动介质恢复过程中保持系统稳定性。 
---
= 关闭控制器以进行手动启动介质恢复 - FAS70 和 FAS90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
关闭 FAS70 或 FAS90 存储系统中受损的控制器，以防止数据丢失并在手动启动介质恢复过程中保持系统稳定性。
