...
summary: 关闭 FAS70 或 FAS90 存储系统中的控制器，以防止数据丢失，并在手动启动介质恢复过程中保持系统稳定性。 
---
= 在手动启动恢复过程中关闭 FAS70 或 FAS90 系统中的控制器
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
关闭 FAS70 或 FAS90 存储系统中的控制器，以防止数据丢失，并在手动启动介质恢复过程中保持系统稳定性。
